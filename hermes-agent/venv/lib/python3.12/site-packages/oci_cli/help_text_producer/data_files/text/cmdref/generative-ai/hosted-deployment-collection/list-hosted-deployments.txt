...
=====
   ...
   oci generative-ai hosted-deployment-collection list-hosted-deployments [OPTIONS]
...
A filter to return only the hosted deployments that their lifecycle
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/generative-ai/hosted-deployment-collection/list-hosted-deployments.html#cmdoption-compartment-id

       oci generative-ai hosted-deployment-collection list-hosted-deployments --compartment-id $compartment_id
