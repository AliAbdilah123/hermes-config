...
Create a compute GPU memory cluster instance on a specific compute GPU
memory fabric
...
=====
   ...
   oci compute compute-gpu-memory-cluster create [OPTIONS]
...
The OCID of the compartment that contains the compute GPU Memory
Cluster. compartment.
...
security policies before trying the examples.
       ...
       oci compute compute-gpu-memory-cluster create --availability-domain $availability_domain --compartment-id $compartment_id --compute-cluster-id $compute_cluster_id --instance-configuration-id $instance_configuration_id
