"validate-and-configure-email-subdomain-dns"
********************************************
...
=====
   ...
   oci fusion-apps email-subdomain validate-and-configure-email-subdomain-dns [OPTIONS]
...
security policies before trying the examples.
       ...
       oci fusion-apps email-subdomain validate-and-configure-email-subdomain-dns --email-subdomain-id $email_subdomain_id --fusion-environment-id $fusion_environment_id --marketing-brand-id $marketing_brand_id
