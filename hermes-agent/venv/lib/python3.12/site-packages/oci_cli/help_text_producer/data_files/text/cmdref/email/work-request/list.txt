...
=====
   ...
   oci email work-request list [OPTIONS]
...
Accepted values are:
   ...
   CREATE_DKIM, CREATE_EMAIL_DOMAIN, CREATE_IP_POOL, CREATE_RETURN_PATH, DELETE_DKIM, DELETE_EMAIL_DOMAIN, DELETE_IP_POOL, DELETE_RETURN_PATH, MOVE_DKIM, MOVE_EMAIL_DOMAIN, MOVE_IP_POOL, UPDATE_DKIM, UPDATE_EMAIL_DOMAIN, UPDATE_IP_POOL, UPDATE_RETURN_PATH
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/email/work-request/list.html#cmdoption-compartment-id

       oci email work-request list --compartment-id $compartment_id
