...
=====
   ...
   oci dbtools connection create-generic-jdbc [OPTIONS]
...
The advanced connection properties key-value pair. This is a complex
...
DatabaseToolsKeyStoreGenericJdbcDetails.  For documentation on
DatabaseToolsKeyStoreGenericJdbcDetails please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/databasetools/20201005/da
tatypes/DatabaseToolsKeyStoreGenericJdbcDetails. This is a complex
type whose value must be valid JSON. The value can be provided as a
string on the command line or passed in as a file using the
file://path/to/file syntax.
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/connection/create-generic-jdbc.html#cmdoption-compartment-id
       export display_name=<substitute-value-of-display_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/connection/create-generic-jdbc.html#cmdoption-display-name
       export url=<substitute-value-of-url> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/connection/create-generic-jdbc.html#cmdoption-url
       export user_name=<substitute-value-of-user_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/connection/create-generic-jdbc.html#cmdoption-user-name
       export user_password_secret_id=<substitute-value-of-user_password_secret_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/connection/create-generic-jdbc.html#cmdoption-user-password-secret-id

       oci dbtools connection create-generic-jdbc --compartment-id $compartment_id --display-name $display_name --url $url --user-name $user_name --user-password-secret-id $user_password_secret_id
