...
=====
   ...
   oci fleet-software-update fsu-readiness-check delete [OPTIONS]
...
security policies before trying the examples.
       ...
       oci fleet-software-update fsu-readiness-check delete --fsu-readiness-check-id $fsu_readiness_check_id
