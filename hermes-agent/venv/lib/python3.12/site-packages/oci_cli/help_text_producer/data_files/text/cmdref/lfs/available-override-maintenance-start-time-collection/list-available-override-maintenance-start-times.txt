"list-available-override-maintenance-start-times"
*************************************************
...
Gets the list of available maintenance start times for Override
operation
...
=====
   ...
   oci lfs available-override-maintenance-start-time-collection list-available-override-maintenance-start-times [OPTIONS]
...
security policies before trying the examples.
       ...
       export id=<substitute-value-of-id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/lfs/available-override-maintenance-start-time-collection/list-available-override-maintenance-start-times.html#cmdoption-id

       oci lfs available-override-maintenance-start-time-collection list-available-override-maintenance-start-times --id $id
