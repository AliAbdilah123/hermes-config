...
Returns list of database API gateway config setting descriptions to be
provided as advanced properties.


Usage
=====

   oci dbtools-runtime database-api-gateway-config-advanced-properties list [OPTIONS]
...
security policies before trying the examples.
       ...
       oci dbtools-runtime database-api-gateway-config-advanced-properties list
