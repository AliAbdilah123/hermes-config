"move-distributed-autonomous-database-replication-unit"
*******************************************************
...
Move the replication units for RAFT based globally distributed
autonomous database from source shard to destination shard.


Usage
=====

   oci distributed-database distributed-autonomous-db-service distributed-autonomous-database move-distributed-autonomous-database-replication-unit [OPTIONS]
...
--source-shard-name [text]

The name of the source shard from which to move the chunks out to
other shards.
...
--destination-shard-name [text]

The name of the destination shard to which the chunks moved out from
source shard should be relocate to.
...
--replication-units [complex type]

For RAFT databases please provide replication unit numbers to be moved
from source shard to destination shard. This is a complex type whose
...
security policies before trying the examples.
       ...
       export source_shard_name=<substitute-value-of-source_shard_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/distributed-database/distributed-autonomous-db-service/distributed-autonomous-database/move-distributed-autonomous-database-replication-unit.html#cmdoption-source-shard-name
       ...
       oci distributed-database distributed-autonomous-db-service distributed-autonomous-database move-distributed-autonomous-database-replication-unit --distributed-autonomous-database-id $distributed_autonomous_database_id --source-shard-name $source_shard_name
