"get-email-subdomain-dns-config"
********************************
...
=====
   ...
   oci fusion-apps email-subdomain get-email-subdomain-dns-config [OPTIONS]
...
security policies before trying the examples.
       ...
       oci fusion-apps email-subdomain get-email-subdomain-dns-config --email-subdomain-id $email_subdomain_id --fusion-environment-id $fusion_environment_id --marketing-brand-id $marketing_brand_id
