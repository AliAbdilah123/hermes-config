...
Lists managed instance groups that match the specified compartment or
managed instance group OCID. Filter the list against a variety of
criteria including but not limited to name, status, architecture, and
OS family.
...
=====
   ...
   oci os-management-hub managed-instance-group list [OPTIONS]
...
A filter to return only managed instance groups that are in the
specified state.
...
security policies before trying the examples.
       ...
       oci os-management-hub managed-instance-group list
