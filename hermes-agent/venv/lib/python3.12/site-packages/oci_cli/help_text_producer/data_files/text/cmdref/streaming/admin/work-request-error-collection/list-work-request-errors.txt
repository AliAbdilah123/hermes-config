...
=====
   ...
   oci streaming admin work-request-error-collection list-work-request-errors [OPTIONS]
...
security policies before trying the examples.
       ...
       export work_request_id=<substitute-value-of-work_request_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/streaming/admin/work-request-error-collection/list-work-request-errors.html#cmdoption-work-request-id

       oci streaming admin work-request-error-collection list-work-request-errors --work-request-id $work_request_id
