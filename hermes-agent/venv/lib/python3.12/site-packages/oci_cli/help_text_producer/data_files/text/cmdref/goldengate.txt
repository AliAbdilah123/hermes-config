...
Use the Oracle Cloud Infrastructure GoldenGate CLI to perform data
...
* connection
  ...
  * create-google-pub-sub-connection
  ...
  * update-amazon-kinesis-connection

  * update-amazon-redshift-connection

  * update-amazon-s3-connection
  ...
  * update-google-big-query-connection

  * update-google-cloud-storage-connection

  * update-google-pub-sub-connection
  ...
  * update-microsoft-fabric-connection

  * update-microsoft-sqlserver-connection

  * update-mongo-db-connection
...
* deployment
  ...
  * generate-disaster-recovery-precheck-report

  * generate-library-url

  * generate-log-reader-component-library-url
...
* deployment-peer-summary

  * list-deployment-peers

* deployment-type-collection
...
* deployment-wallets-operation-summary
...
* pipeline
  ...
  * pause-pipeline-default-pause-pipeline-details
  ...
  * update-zero-etl-pipeline

* pipeline-recipe-collection
