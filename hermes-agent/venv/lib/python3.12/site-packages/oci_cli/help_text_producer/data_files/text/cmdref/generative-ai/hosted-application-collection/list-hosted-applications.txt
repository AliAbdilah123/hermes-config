...
=====
   ...
   oci generative-ai hosted-application-collection list-hosted-applications [OPTIONS]
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/generative-ai/hosted-application-collection/list-hosted-applications.html#cmdoption-compartment-id

       oci generative-ai hosted-application-collection list-hosted-applications --compartment-id $compartment_id
