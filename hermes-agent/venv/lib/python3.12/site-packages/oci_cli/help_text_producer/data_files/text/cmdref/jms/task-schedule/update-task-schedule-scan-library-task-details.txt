"update-task-schedule-scan-library-task-details"
************************************************
...
=====
   ...
   oci jms task-schedule update-task-schedule-scan-library-task-details [OPTIONS]
...
security policies before trying the examples.
       ...
       oci jms task-schedule update-task-schedule-scan-library-task-details --execution-recurrences $execution_recurrences --fleet-id $fleet_id --task-schedule-id $task_schedule_id
