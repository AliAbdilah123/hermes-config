...
=====
   ...
   oci fusion-apps vanity-domain update [OPTIONS]
...
security policies before trying the examples.
       ...
       oci fusion-apps vanity-domain update --fusion-environment-id $fusion_environment_id --vanity-domain-id $vanity_domain_id
