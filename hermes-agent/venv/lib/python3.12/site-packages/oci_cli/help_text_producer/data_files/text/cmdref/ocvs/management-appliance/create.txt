...
=====
   ...
   oci ocvs management-appliance create [OPTIONS]
...
security policies before trying the examples.
       ...
       oci ocvs management-appliance create --configuration file://configuration.json --connections file://connections.json --display-name $display_name --sddc-id $sddc_id
