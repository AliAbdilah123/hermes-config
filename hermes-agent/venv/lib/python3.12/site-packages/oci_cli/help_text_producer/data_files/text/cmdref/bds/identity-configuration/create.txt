...
=====
   ...
   oci bds identity-configuration create [OPTIONS]
...
--confidential-application-id [text]

Identity domain confidential application ID for the identity config,
required for creating identity configuration

--display-name [text]

Display name of the identity configuration, required for creating
identity configuration.

--identity-domain-id [text]

Identity domain OCID to use for identity config, required for creating
identity configuration
...
security policies before trying the examples.
       ...
       oci bds identity-configuration create --bds-instance-id $bds_instance_id --confidential-application-id $confidential_application_id --display-name $display_name --identity-domain-id $identity_domain_id
