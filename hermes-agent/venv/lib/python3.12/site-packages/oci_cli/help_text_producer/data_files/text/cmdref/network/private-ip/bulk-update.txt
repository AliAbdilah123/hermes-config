...
=====
   ...
   oci network private-ip bulk-update [OPTIONS]


Required Parameters
===================

--bulk-update-private-ip-item [complex type]

A secondary IPv4 address to update. This is a complex type whose value
...
The OCID of the VNIC to reassign the private IPs to. The VNIC and
...
example parameters with your own.
       ...
       oci network private-ip bulk-update --generate-param-json-input bulk-update-private-ip-item > bulk-update-private-ip-item.json
...
security policies before trying the examples.
       ...
       oci network private-ip bulk-update --bulk-update-private-ip-item file://bulk-update-private-ip-item.json
