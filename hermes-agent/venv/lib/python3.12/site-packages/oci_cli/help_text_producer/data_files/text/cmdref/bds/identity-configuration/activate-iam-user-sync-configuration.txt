...
Activate IAM user sync configuration for the given identity
configuration
...
=====
   ...
   oci bds identity-configuration activate-iam-user-sync-configuration [OPTIONS]
...
--is-posix-attributes-addition-required [boolean]
...
security policies before trying the examples.
       ...
       oci bds identity-configuration activate-iam-user-sync-configuration --bds-instance-id $bds_instance_id --identity-configuration-id $identity_configuration_id
