"update-autonomous-database-oci-key-details"
********************************************
...
=====
   ...
   oci db autonomous-database update-autonomous-database-oci-key-details [OPTIONS]
...
--encryption-key-kms-key-id [text]
...
security policies before trying the examples.
       ...
       export encryption_key_kms_key_id=<substitute-value-of-encryption_key_kms_key_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/autonomous-database/update-autonomous-database-oci-key-details.html#cmdoption-encryption-key-kms-key-id
       export encryption_key_vault_id=<substitute-value-of-encryption_key_vault_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/autonomous-database/update-autonomous-database-oci-key-details.html#cmdoption-encryption-key-vault-id
       ...
       oci db autonomous-database update-autonomous-database-oci-key-details --autonomous-database-id $autonomous_database_id --encryption-key-kms-key-id $encryption_key_kms_key_id --encryption-key-vault-id $encryption_key_vault_id
