...
Disables management audit logging for the given HSM Cluster resource.
This requires the Crypto Officer (CO) password. This operation is
idempotent: if audit logging is already disabled, the call is a no-op
and returns success.
...
=====
   ...
   oci kms kms-hsm-cluster hsm-cluster disable-audit-mgmt-logging [OPTIONS]
...
security policies before trying the examples.
       ...
       oci kms kms-hsm-cluster hsm-cluster disable-audit-mgmt-logging --hsm-cluster-id $hsm_cluster_id
