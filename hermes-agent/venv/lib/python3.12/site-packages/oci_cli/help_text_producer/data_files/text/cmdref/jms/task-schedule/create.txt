...
=====
   ...
   oci jms task-schedule create [OPTIONS]
...
security policies before trying the examples.
       ...
       oci jms task-schedule create --execution-recurrences $execution_recurrences --fleet-id $fleet_id --task-details file://task-details.json
