...
=====
   ...
   oci os-management-hub software-source create-custom-swsrc [OPTIONS]
...
example parameters with your own.
       ...
       oci os-management-hub software-source create-custom-swsrc --generate-param-json-input vendor-software-sources > vendor-software-sources.json
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/os-management-hub/software-source/create-custom-swsrc.html#cmdoption-compartment-id

       oci os-management-hub software-source create-custom-swsrc --compartment-id $compartment_id --vendor-software-sources file://vendor-software-sources.json
