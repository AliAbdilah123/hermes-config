...
Deletes the specified limit increase request. For more information,
see Deleting a Limit Increase Request.


Usage
=====

   oci limits-increase limits-increase-request delete [OPTIONS]
...
--wait-for-state" ACCEPTED "--wait-for-state" FAILED would return on
...
security policies before trying the examples.
       ...
       export id=<substitute-value-of-id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/limits-increase/limits-increase-request/delete.html#cmdoption-id

       oci limits-increase limits-increase-request delete --id $id
