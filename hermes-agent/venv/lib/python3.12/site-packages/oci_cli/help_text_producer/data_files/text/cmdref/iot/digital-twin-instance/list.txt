...
Retrieves a list of digital twin instances within the specified IoT
domain.
...
=====
   ...
   oci iot digital-twin-instance list [OPTIONS]
...
Filter resources that match the specified OCID of the digital twin
model.

--digital-twin-model-spec-uri [text]

Filter resources that match the specified URI (DTMI) of the digital
twin model.
...
security policies before trying the examples.
       ...
       export iot_domain_id=<substitute-value-of-iot_domain_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/iot/digital-twin-instance/list.html#cmdoption-iot-domain-id

       oci iot digital-twin-instance list --iot-domain-id $iot_domain_id
