...
Returns a paginated list of *CredentialSummary* for the specified
request.
...
=====
   ...
   oci dbtools-runtime connection list-credentials [OPTIONS]
...
security policies before trying the examples.
       ...
       export connection_id=<substitute-value-of-connection_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools-runtime/connection/list-credentials.html#cmdoption-connection-id

       oci dbtools-runtime connection list-credentials --connection-id $connection_id
