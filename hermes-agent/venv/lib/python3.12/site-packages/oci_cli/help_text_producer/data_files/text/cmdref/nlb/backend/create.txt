...
If not specified, then one will be generated. Example: *webServer1*
...
Backend servers with a higher weight receive a larger proportion of
incoming traffic. For example, a server weighted ‘3’ receives three
times the number of new connections as a server weighted ‘1’. For more
