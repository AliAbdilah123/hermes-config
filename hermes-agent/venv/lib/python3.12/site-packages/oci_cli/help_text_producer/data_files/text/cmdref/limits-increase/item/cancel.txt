...
Withdraws the specified item from the limit increase request. For more
information, see Withdrawing an Item from a Limit Increase Request.


Usage
=====

   oci limits-increase item cancel [OPTIONS]
...
security policies before trying the examples.
       ...
       export id=<substitute-value-of-id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/limits-increase/item/cancel.html#cmdoption-id

       oci limits-increase item cancel --id $id
