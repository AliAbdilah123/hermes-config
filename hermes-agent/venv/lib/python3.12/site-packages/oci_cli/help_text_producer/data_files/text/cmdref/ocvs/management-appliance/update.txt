...
=====
   ...
   oci ocvs management-appliance update [OPTIONS]
...
ManagementApplianceConnection please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/managementappliance/20230
701/datatypes/ManagementApplianceConnection. This is a complex type
...
example parameters with your own.
       ...
       oci ocvs management-appliance create --generate-param-json-input configuration > configuration.json
       oci ocvs management-appliance create --generate-param-json-input connections > connections.json
...
security policies before trying the examples.
       ...
       export display_name=<substitute-value-of-display_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/ocvs/management-appliance/create.html#cmdoption-display-name
       ...
       management_appliance_id=$(oci ocvs management-appliance create --configuration file://configuration.json --connections file://connections.json --display-name $display_name --sddc-id $sddc_id --query data.id --raw-output)

       oci ocvs management-appliance update --management-appliance-id $management_appliance_id
