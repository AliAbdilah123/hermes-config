"update-oracle-database-resource-principal"
*******************************************
...
=====
   ...
   oci dbtools identity update-oracle-database-resource-principal [OPTIONS]
...
security policies before trying the examples.
       ...
       export identity_id=<substitute-value-of-identity_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/identity/update-oracle-database-resource-principal.html#cmdoption-identity-id

       oci dbtools identity update-oracle-database-resource-principal --identity-id $identity_id
