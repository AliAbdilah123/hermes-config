...
Returns a list of supported cloud regions related to
AssetSourceTypeParam.


Usage
=====

   oci cloud-bridge discovery supported-cloud-regions list [OPTIONS]
...
A filter to return only supported cloud regions which name contains
given nameContains as sub-string.
...
The field to sort by. Only one sort order may be provided. By default,
name is in ascending order.
