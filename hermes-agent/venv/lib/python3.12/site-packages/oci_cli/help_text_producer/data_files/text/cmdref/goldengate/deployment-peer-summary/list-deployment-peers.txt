...
=====
   ...
   oci goldengate deployment-peer-summary list-deployment-peers [OPTIONS]
...
A filter to return only the deployment peers having the
‘lifecycleState’ given.
...
security policies before trying the examples.
       ...
       export deployment_id=<substitute-value-of-deployment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/goldengate/deployment-peer-summary/list-deployment-peers.html#cmdoption-deployment-id

       oci goldengate deployment-peer-summary list-deployment-peers --deployment-id $deployment_id
