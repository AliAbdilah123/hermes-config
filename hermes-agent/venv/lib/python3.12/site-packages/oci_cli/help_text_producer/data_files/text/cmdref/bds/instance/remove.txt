...
=====
   ...
   oci bds instance remove [OPTIONS]
...
Boolean flag specifying whether or not to force remove node if
...
security policies before trying the examples.
       ...
       export bds_instance_id=<substitute-value-of-bds_instance_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/bds/instance/remove.html#cmdoption-bds-instance-id
       export node_id=<substitute-value-of-node_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/bds/instance/remove.html#cmdoption-node-id

       oci bds instance remove --bds-instance-id $bds_instance_id --node-id $node_id
