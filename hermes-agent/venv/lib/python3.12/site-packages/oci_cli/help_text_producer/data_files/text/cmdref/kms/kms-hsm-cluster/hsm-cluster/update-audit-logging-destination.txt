...
update bucket details of management audit logs for a HSM cluster
resource by hsmClusterId.


Usage
=====

   oci kms kms-hsm-cluster hsm-cluster update-audit-logging-destination [OPTIONS]
...
The compartmentId OCID under namespace to which audit logs will be
stored.

--hsm-cluster-id [text]

The OCID of the HSM Cluster. This is a unique identifier assigned to
each hsmCluster.
...
security policies before trying the examples.
       ...
       export bucket_name=<substitute-value-of-bucket_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/kms/kms-hsm-cluster/hsm-cluster/update-audit-logging-destination.html#cmdoption-bucket-name
       export namespace=<substitute-value-of-namespace> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/kms/kms-hsm-cluster/hsm-cluster/update-audit-logging-destination.html#cmdoption-namespace
       ...
       oci kms kms-hsm-cluster hsm-cluster update-audit-logging-destination --bucket-name $bucket_name --compartment-id $compartment_id --hsm-cluster-id $hsm_cluster_id --namespace $namespace
