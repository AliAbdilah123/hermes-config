...
=====
   ...
   oci fusion-apps email-subdomain get-email-subdomain-csr [OPTIONS]
...
security policies before trying the examples.
       ...
       oci fusion-apps email-subdomain get-email-subdomain-csr --email-subdomain-id $email_subdomain_id --fusion-environment-id $fusion_environment_id --marketing-brand-id $marketing_brand_id
