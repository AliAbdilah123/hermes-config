...
Creates a GenerativeAiProject. The header contains an opc-work-
request-id, which is the id for the WorkRequest that tracks the
generativeAiProject creation progress.


Usage
=====

   oci generative-ai generative-ai-project create [OPTIONS]
...
security policies before trying the examples.
       ...
       oci generative-ai generative-ai-project create --compartment-id $compartment_id
