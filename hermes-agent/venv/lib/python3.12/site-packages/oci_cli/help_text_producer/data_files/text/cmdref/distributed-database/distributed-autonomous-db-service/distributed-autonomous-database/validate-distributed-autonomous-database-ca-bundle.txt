"validate-distributed-autonomous-database-ca-bundle"
****************************************************
...
Validate the CA Bundles consistency of the globally distributed
autonomous database.
...
=====
   ...
   oci distributed-database distributed-autonomous-db-service distributed-autonomous-database validate-distributed-autonomous-database-ca-bundle [OPTIONS]
...
security policies before trying the examples.
       ...
       oci distributed-database distributed-autonomous-db-service distributed-autonomous-database validate-distributed-autonomous-database-ca-bundle --distributed-autonomous-database-id $distributed_autonomous_database_id
