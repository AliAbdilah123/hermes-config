...
=====
   ...
   oci db scheduling-policy list [OPTIONS]
...
A filter to return only resources that match the given cadence period
exactly.

Accepted values are:

   HALFYEARLY, MONTHLY, QUARTERLY
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/scheduling-policy/list.html#cmdoption-compartment-id

       oci db scheduling-policy list --compartment-id $compartment_id
