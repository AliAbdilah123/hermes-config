"update-autonomous-database-aws-key-details"
********************************************
...
=====
   ...
   oci db autonomous-database update-autonomous-database-aws-key-details [OPTIONS]
...
--encryption-key-key-arn [text]

AWS key ARN

--encryption-key-service-endpoint-uri [text]
...
--encryption-key-arn-role [text]

AWS ARN role

--encryption-key-external-id [text]
...
security policies before trying the examples.
       ...
       export encryption_key_key_arn=<substitute-value-of-encryption_key_key_arn> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/autonomous-database/update-autonomous-database-aws-key-details.html#cmdoption-encryption-key-key-arn
       export encryption_key_service_endpoint_uri=<substitute-value-of-encryption_key_service_endpoint_uri> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/autonomous-database/update-autonomous-database-aws-key-details.html#cmdoption-encryption-key-service-endpoint-uri
       ...
       oci db autonomous-database update-autonomous-database-aws-key-details --autonomous-database-id $autonomous_database_id --encryption-key-key-arn $encryption_key_key_arn --encryption-key-service-endpoint-uri $encryption_key_service_endpoint_uri
