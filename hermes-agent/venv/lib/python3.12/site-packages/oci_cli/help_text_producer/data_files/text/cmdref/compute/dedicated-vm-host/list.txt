...
Returns the list of dedicated virtual machine hosts that match the
specified criteria in the specified compartment.

You can limit the list by specifying a dedicated virtual machine host
display name. The list will include all the identically-named
...
=====
   ...
   oci compute dedicated-vm-host list [OPTIONS]
...
--remaining-local-volume-in-gbs-greater-than-or-equal-to [float]

The remaining local volume of the dedicated VM host, in GBs.

--remaining-memory-in-gbs-greater-than-or-equal-to [float]

The remaining memory of the dedicated VM host, in GBs.

--remaining-ocpus-greater-than-or-equal-to [float]
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/compute/dedicated-vm-host/list.html#cmdoption-compartment-id
