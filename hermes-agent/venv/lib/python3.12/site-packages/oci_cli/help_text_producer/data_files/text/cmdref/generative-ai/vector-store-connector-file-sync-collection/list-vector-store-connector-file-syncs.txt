"list-vector-store-connector-file-syncs"
****************************************
...
=====
   ...
   oci generative-ai vector-store-connector-file-sync-collection list-vector-store-connector-file-syncs [OPTIONS]
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/generative-ai/vector-store-connector-file-sync-collection/list-vector-store-connector-file-syncs.html#cmdoption-compartment-id

       oci generative-ai vector-store-connector-file-sync-collection list-vector-store-connector-file-syncs --compartment-id $compartment_id
