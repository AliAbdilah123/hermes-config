...
List all compute targets in the specified compartment. Supports
queries on various other parameters in the query alongside
compartmentId (must be included).


Usage
=====

   oci data-science compute-target list [OPTIONS]
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/data-science/compute-target/list.html#cmdoption-compartment-id

       oci data-science compute-target list --compartment-id $compartment_id
