...
Returns a list of BDS certificate configurations associated with this
...
=====
   ...
   oci bds bds-certificate-configuration list [OPTIONS]
...
security policies before trying the examples.
       ...
       export bds_instance_id=<substitute-value-of-bds_instance_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/bds/bds-certificate-configuration/list.html#cmdoption-bds-instance-id

       oci bds bds-certificate-configuration list --bds-instance-id $bds_instance_id
