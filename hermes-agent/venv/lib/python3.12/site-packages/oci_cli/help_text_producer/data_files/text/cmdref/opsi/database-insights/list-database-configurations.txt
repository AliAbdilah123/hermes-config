...
Gets a list of database insight configurations based on the query
parameters specified. Either compartmentId or databaseInsightId query
parameter must be specified. When both compartmentId and
compartmentIdInSubtree are specified, a list of database insight
configurations in that compartment and in all sub-compartments will be
returned.
...
=====
   ...
   oci opsi database-insights list-database-configurations [OPTIONS]
...
Database configuration list sort options. If *fields* parameter is
selected, the *sortBy* parameter must be one of the fields specified.
