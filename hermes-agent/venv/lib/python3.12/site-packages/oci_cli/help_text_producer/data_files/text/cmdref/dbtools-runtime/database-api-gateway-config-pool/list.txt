...
Returns a list of Database Tools database API gateway config pool
resources
...
=====
   ...
   oci dbtools-runtime database-api-gateway-config-pool list [OPTIONS]
...
security policies before trying the examples.
       ...
       export database_api_gateway_config_id=<substitute-value-of-database_api_gateway_config_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools-runtime/database-api-gateway-config-pool/list.html#cmdoption-database-api-gateway-config-id

       oci dbtools-runtime database-api-gateway-config-pool list --database-api-gateway-config-id $database_api_gateway_config_id
