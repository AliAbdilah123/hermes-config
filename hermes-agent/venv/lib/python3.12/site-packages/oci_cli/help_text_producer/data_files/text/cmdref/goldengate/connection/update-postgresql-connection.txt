...
=====
   ...
   oci goldengate connection update-postgresql-connection [OPTIONS]
...
.crt. It is not included in GET responses if the *view=COMPACT* query
parameter is specified.

--ssl-cert [text]

The base64 encoded certificate of the PostgreSQL server. The supported
file formats are .pem and .crt. It is not included in GET responses if
the *view=COMPACT* query parameter is specified.

--ssl-crl [text]

The base64 encoded list of certificates revoked by the trusted
certificate authorities (Trusted CA). It is not included in GET
responses if the *view=COMPACT* query parameter is specified.
...
security policies before trying the examples.
       ...
       export connection_id=<substitute-value-of-connection_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/goldengate/connection/update-postgresql-connection.html#cmdoption-connection-id

       oci goldengate connection update-postgresql-connection --connection-id $connection_id
