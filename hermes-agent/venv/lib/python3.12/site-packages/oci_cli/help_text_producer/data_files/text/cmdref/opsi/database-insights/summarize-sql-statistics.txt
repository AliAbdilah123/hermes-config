...
31st, 2025. Query SQL Warehouse to get the performance statistics for
SQLs taking greater than X% database time for a given time period
across the given databases or database types in a compartment and in
all sub-compartments if specified.
...
The field to use when sorting SQL statistics. Example:
databaseTimeInSec
