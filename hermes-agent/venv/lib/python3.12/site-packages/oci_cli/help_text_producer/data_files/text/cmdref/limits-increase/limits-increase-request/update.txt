...
Updates the limit increase request. For more information, see Updating
...
=====
   ...
   oci limits-increase limits-increase-request update [OPTIONS]
...
security policies before trying the examples.
       ...
       export id=<substitute-value-of-id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/limits-increase/limits-increase-request/update.html#cmdoption-id

       oci limits-increase limits-increase-request update --id $id
