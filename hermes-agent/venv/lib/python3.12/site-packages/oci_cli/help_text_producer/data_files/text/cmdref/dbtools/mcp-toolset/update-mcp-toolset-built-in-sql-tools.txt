"update-mcp-toolset-built-in-sql-tools"
***************************************
...
Updates the specified Database Tools MCP Toolset for built-in SQL
tools.
...
=====
   ...
   oci dbtools mcp-toolset update-mcp-toolset-built-in-sql-tools [OPTIONS]
...
security policies before trying the examples.
       ...
       export mcp_toolset_id=<substitute-value-of-mcp_toolset_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/mcp-toolset/update-mcp-toolset-built-in-sql-tools.html#cmdoption-mcp-toolset-id

       oci dbtools mcp-toolset update-mcp-toolset-built-in-sql-tools --mcp-toolset-id $mcp_toolset_id
