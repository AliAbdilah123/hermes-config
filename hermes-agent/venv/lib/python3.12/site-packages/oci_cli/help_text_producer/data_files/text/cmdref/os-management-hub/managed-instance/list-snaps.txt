...
Retrieves a list of snaps for a managed instance. Filters may be
applied to select a subset of snaps based on the filter criteria.


Usage
=====

   oci os-management-hub managed-instance list-snaps [OPTIONS]
...
security policies before trying the examples.
       ...
       export managed_instance_id=<substitute-value-of-managed_instance_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/os-management-hub/managed-instance/list-snaps.html#cmdoption-managed-instance-id

       oci os-management-hub managed-instance list-snaps --managed-instance-id $managed_instance_id
