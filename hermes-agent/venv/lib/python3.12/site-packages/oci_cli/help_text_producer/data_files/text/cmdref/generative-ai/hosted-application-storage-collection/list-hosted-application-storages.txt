"list-hosted-application-storages"
**********************************
...
=====
   ...
   oci generative-ai hosted-application-storage-collection list-hosted-application-storages [OPTIONS]
...
--hosted-application-storage-type [text]

The type of the hosted application storage.

Accepted values are:

   ADB, CACHE, POSTGRESQL
...
A filter to return only the hosted applications that their lifecycle
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/generative-ai/hosted-application-storage-collection/list-hosted-application-storages.html#cmdoption-compartment-id

       oci generative-ai hosted-application-storage-collection list-hosted-application-storages --compartment-id $compartment_id
