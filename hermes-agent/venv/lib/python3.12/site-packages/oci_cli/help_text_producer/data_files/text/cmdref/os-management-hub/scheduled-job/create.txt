...
--dynamic-set-ids [complex type]

The dynamic set OCIDs that this scheduled job operates on. A scheduled
job can only operate on one type of target. therefore this parameter
is mutually exclusive with managedInstanceIds,
...
0220901/datatypes/ManagedInstanceLocation. This is a complex type
...
managedInstanceGroupIds, or lifecycleStageIds, or dynamicSetIds. This
...
managedCompartmentIds, or lifecycleStageIds, or dynamicSetIds. This is
...
format. Note: Currently, only FREQ/INTERVAL/BYMONTHDAY/BYDAY/BYSETPOS
/BYMONTH/BYHOUR/BYMINUTE/BYSECOND rules are supported. In FREQ, only
