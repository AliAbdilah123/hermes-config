...
Deletes the specified Database Tools database API gateway config pool
resource.
...
=====
   ...
   oci dbtools-runtime database-api-gateway-config-pool delete [OPTIONS]
...
security policies before trying the examples.
       ...
       export database_api_gateway_config_id=<substitute-value-of-database_api_gateway_config_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools-runtime/database-api-gateway-config-pool/delete.html#cmdoption-database-api-gateway-config-id
       export pool_key=<substitute-value-of-pool_key> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools-runtime/database-api-gateway-config-pool/delete.html#cmdoption-pool-key

       oci dbtools-runtime database-api-gateway-config-pool delete --database-api-gateway-config-id $database_api_gateway_config_id --pool-key $pool_key
