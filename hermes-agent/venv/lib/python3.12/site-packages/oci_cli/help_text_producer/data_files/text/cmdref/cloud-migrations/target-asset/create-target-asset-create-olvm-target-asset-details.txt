"create-target-asset-create-olvm-target-asset-details"
******************************************************
...
=====
   ...
   oci cloud-migrations target-asset create-target-asset-create-olvm-target-asset-details [OPTIONS]
...
security policies before trying the examples.
       ...
       export is_excluded_from_execution=<substitute-value-of-is_excluded_from_execution> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/cloud-migrations/target-asset/create-target-asset-create-olvm-target-asset-details.html#cmdoption-is-excluded-from-execution
       ...
       oci cloud-migrations target-asset create-target-asset-create-olvm-target-asset-details --is-excluded-from-execution $is_excluded_from_execution --migration-plan-id $migration_plan_id
