...
Creates a new snapshot of the specified file system. You can access
the snapshot at *.snapshot/<name>*.
...
Name of the snapshot. This value is immutable. It must also be unique
with respect to all other non-DELETED snapshots on the associated file
system.
...
--lock-duration-details [complex type]
...
us/iaas/api/#/en/filestorage/20171215/datatypes/ResourceLock. This is
...
security policies before trying the examples.
       ...
       export name=<substitute-value-of-name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fs/snapshot/create.html#cmdoption-name
       ...
       oci fs snapshot create --file-system-id $file_system_id --name $name
