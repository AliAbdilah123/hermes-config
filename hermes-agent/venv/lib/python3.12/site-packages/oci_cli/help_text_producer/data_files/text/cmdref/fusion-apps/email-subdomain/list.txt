...
=====
   ...
   oci fusion-apps email-subdomain list [OPTIONS]
...
security policies before trying the examples.
       ...
       oci fusion-apps email-subdomain list --fusion-environment-id $fusion_environment_id --marketing-brand-id $marketing_brand_id
