...
<b>Filter</b> results by the OCID of the resource associated with the
work request.

--sort-by [text]

Specifies the field to sort by. Accepts only one field. By default,
when you sort by time fields, the results are shown in descending
order. All other fields default to ascending order.
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/data-science/work-request/list.html#cmdoption-compartment-id

       oci data-science work-request list --compartment-id $compartment_id
