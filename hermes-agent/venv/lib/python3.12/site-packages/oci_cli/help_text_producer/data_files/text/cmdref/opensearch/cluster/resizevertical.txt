...
=====
   ...
   oci opensearch cluster resizevertical [OPTIONS]
...
The amount of memory in GB, to configure for the cluster’s master
nodes.
...
security policies before trying the examples.
       ...
       export opensearch_cluster_id=<substitute-value-of-opensearch_cluster_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/opensearch/cluster/resizevertical.html#cmdoption-opensearch-cluster-id

       oci opensearch cluster resizevertical --opensearch-cluster-id $opensearch_cluster_id
