...
=====
   ...
   oci goldengate connection migrate [OPTIONS]
...
The type of a migrate Connection.
...
security policies before trying the examples.
       ...
       export connection_id=<substitute-value-of-connection_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/goldengate/connection/migrate.html#cmdoption-connection-id
       export type=<substitute-value-of-type> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/goldengate/connection/migrate.html#cmdoption-type

       oci goldengate connection migrate --connection-id $connection_id --type $type
