...
=====
   ...
   oci dbtools-runtime credential list-execute-grantees [OPTIONS]
...
security policies before trying the examples.
       ...
       export connection_id=<substitute-value-of-connection_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools-runtime/credential/list-execute-grantees.html#cmdoption-connection-id
       export credential_key=<substitute-value-of-credential_key> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools-runtime/credential/list-execute-grantees.html#cmdoption-credential-key

       oci dbtools-runtime credential list-execute-grantees --connection-id $connection_id --credential-key $credential_key
