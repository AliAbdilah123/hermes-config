...
Returns a list of packages that are available for installation on a
managed instance.
...
=====
   ...
   oci os-management-hub managed-instance list-available-packages [OPTIONS]
...
pagination works, see List Pagination. Example: *700*
...
security policies before trying the examples.
       ...
       export managed_instance_id=<substitute-value-of-managed_instance_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/os-management-hub/managed-instance/list-available-packages.html#cmdoption-managed-instance-id

       oci os-management-hub managed-instance list-available-packages --managed-instance-id $managed_instance_id
