...
=====
   ...
   oci self subscription work-request-log-entry list-work-request-logs [OPTIONS]
...
security policies before trying the examples.
       ...
       export work_request_id=<substitute-value-of-work_request_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/self/subscription/work-request-log-entry/list-work-request-logs.html#cmdoption-work-request-id

       oci self subscription work-request-log-entry list-work-request-logs --work-request-id $work_request_id
