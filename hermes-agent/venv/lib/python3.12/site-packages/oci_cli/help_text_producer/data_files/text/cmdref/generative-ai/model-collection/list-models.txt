...
Lists the models in a specific compartment. Includes pretrained base
models and fine-tuned custom models.


Usage
=====

   oci generative-ai model-collection list-models [OPTIONS]
...
Accepted values are:
   ...
   AUDIO_TO_AUDIO, AUDIO_TO_TEXT, CHAT, FINE_TUNE, IMAGE_TEXT_TO_IMAGE, IMAGE_TEXT_TO_TEXT, IMAGE_TEXT_TO_VIDEO, IMAGE_TO_IMAGE, REALTIME, TEXT_EMBEDDINGS, TEXT_GENERATION, TEXT_RERANK, TEXT_SUMMARIZATION, TEXT_TO_AUDIO, TEXT_TO_IMAGE, TEXT_TO_VIDEO
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/generative-ai/model-collection/list-models.html#cmdoption-compartment-id

       oci generative-ai model-collection list-models --compartment-id $compartment_id
