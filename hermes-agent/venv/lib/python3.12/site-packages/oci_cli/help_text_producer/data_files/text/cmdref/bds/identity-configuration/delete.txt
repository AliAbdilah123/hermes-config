...
Deletion is only allowed if this identity configuration is not
associated with any active IAM user sync configuration or UPST
configuration.
...
=====
   ...
   oci bds identity-configuration delete [OPTIONS]
...
security policies before trying the examples.
       ...
       oci bds identity-configuration delete --bds-instance-id $bds_instance_id --identity-configuration-id $identity_configuration_id
