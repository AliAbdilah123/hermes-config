...
=====
   ...
   oci network ipv6 bulk-update [OPTIONS]


Required Parameters
===================

--bulk-update-ipv6s-item [complex type]

A secondary IPv6 address to update. This is a complex type whose value
...
The OCID of the VNIC to move the IPv6s to. The VNIC and IPv6s must be
in the same subnet.
...
example parameters with your own.
       ...
       oci network ipv6 bulk-update --generate-param-json-input bulk-update-ipv6s-item > bulk-update-ipv6s-item.json
...
security policies before trying the examples.
       ...
       oci network ipv6 bulk-update --bulk-update-ipv6s-item file://bulk-update-ipv6s-item.json
