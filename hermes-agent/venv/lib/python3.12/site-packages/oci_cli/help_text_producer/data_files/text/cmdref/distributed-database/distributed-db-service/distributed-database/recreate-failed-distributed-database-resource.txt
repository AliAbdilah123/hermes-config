...
=====
   ...
   oci distributed-database distributed-db-service distributed-database recreate-failed-distributed-database-resource [OPTIONS]
...
security policies before trying the examples.
       ...
       export resource_name=<substitute-value-of-resource_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/distributed-database/distributed-db-service/distributed-database/recreate-failed-distributed-database-resource.html#cmdoption-resource-name
       ...
       oci distributed-database distributed-db-service distributed-database recreate-failed-distributed-database-resource --distributed-database-id $distributed_database_id --resource-name $resource_name
