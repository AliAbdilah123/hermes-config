...
=====
   ...
   oci bds instance remove-nodes [OPTIONS]
...
--instance-ids [complex type]

List of instance IDs to be removed. This is a complex type whose value
...
--is-force-remove-enabled [boolean]

Boolean flag specifying whether or not to force remove nodes if
graceful removal fails.
...
example parameters with your own.
       ...
       oci bds instance remove-nodes --generate-param-json-input instance-ids > instance-ids.json
...
security policies before trying the examples.
       ...
       export bds_instance_id=<substitute-value-of-bds_instance_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/bds/instance/remove-nodes.html#cmdoption-bds-instance-id

       oci bds instance remove-nodes --bds-instance-id $bds_instance_id --instance-ids file://instance-ids.json
