...
=====
   ...
   oci jms installation-usage summarize [OPTIONS]
...
required ones. This parameter can also include
...
The field to sort installation views. Only one sort order may be
provided. Default order for _timeFirstSeen_, _timeLastSeen_, and
_jreVersion_, _approximateApplicationCount_ and
_approximateManagedInstanceCount_  is **descending**. Default order
for _jreDistribution_ and _jreVendor_ is **ascending**. If no value is
...
security policies before trying the examples.
       ...
       oci jms installation-usage summarize --fleet-id $fleet_id
