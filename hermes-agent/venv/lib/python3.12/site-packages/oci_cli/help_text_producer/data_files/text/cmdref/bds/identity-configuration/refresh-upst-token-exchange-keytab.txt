...
Refresh token exchange kerberos principal keytab for the UPST enabled
...
security policies before trying the examples.
       ...
       oci bds identity-configuration refresh-upst-token-exchange-keytab --bds-instance-id $bds_instance_id --identity-configuration-id $identity_configuration_id
