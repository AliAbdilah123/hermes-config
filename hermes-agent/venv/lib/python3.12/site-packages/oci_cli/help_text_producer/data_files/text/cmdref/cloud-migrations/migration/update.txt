...
=====
   ...
   oci cloud-migrations migration update [OPTIONS]
...
type or scope. It exists only for cross-compatibility. Example:
...
Type of migration project (OCI/OLVM). This determines the target
environment for the migration.
...
security policies before trying the examples.
       ...
       oci cloud-migrations migration update --migration-id $migration_id
