...
Returns a report of managed instances matching the given filters. You
can select CSV, XML, or JSON format.
...
--other-updates-available-equals-to [integer]

A filter to return instances that have the specified number of
available other updates.

--other-updates-available-greater-than [integer]

A filter to return instances that have more available other updates
...
Accepted values are:
   ...
   ACTIVITY, ALL, BUGFIX, OTHER, SECURITY
