...
A filter to return the OCI Cache Config Set resources, whose lifecycle
...
Accepted values are:
   ...
   REDIS_7_0, V7_0_5, VALKEY_7_2, VALKEY_8_1
...
security policies before trying the examples.
       ...
       oci redis oci-cache-config-set oci-cache-config-set-summary list-oci-cache-config-sets
