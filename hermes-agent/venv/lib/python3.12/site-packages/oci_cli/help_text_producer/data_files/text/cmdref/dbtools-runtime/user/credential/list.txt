...
Returns a paginated list of user *UserCredentialSummary* for the
specified request.
...
=====
   ...
   oci dbtools-runtime user credential list [OPTIONS]
...
security policies before trying the examples.
       ...
       export connection_id=<substitute-value-of-connection_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools-runtime/user/credential/list.html#cmdoption-connection-id
       export user_key=<substitute-value-of-user_key> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools-runtime/user/credential/list.html#cmdoption-user-key

       oci dbtools-runtime user credential list --connection-id $connection_id --user-key $user_key
