...
The availability domain the file system is in. May be unset as a blank
or NULL value.
...
Capacity of the Lustre file system in GB. You can increase capacity
only in multiples of 5 TB.
...
The Lustre file system name. This is used in mount commands and other
aspects of the client command line interface. The file system name is
limited to 8 characters. Allowed characters are lower and upper case
English letters, numbers, and ‘_’. If you have multiple Lustre file
systems mounted on the same clients, this name can help distinguish
them.

--performance-tier [text]

The Lustre file system performance tier. A value of *MBPS_PER_TB_125*
...
The OCID of the cluster placement group in which the Lustre file
system exists.
...
Short description of the Lustre file system. Avoid entering
...
A list of Network Security Group OCIDs associated with this lustre
file system. A maximum of 5 is allowed. Setting this to an empty array
after the list is created removes the lustre file system from all
NSGs. For more information about NSGs, see Security Rules. This is a
