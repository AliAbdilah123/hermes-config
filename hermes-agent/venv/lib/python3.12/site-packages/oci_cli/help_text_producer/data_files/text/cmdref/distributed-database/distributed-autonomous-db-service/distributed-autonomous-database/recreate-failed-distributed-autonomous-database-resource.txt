"recreate-failed-distributed-autonomous-database-resource"
**********************************************************
...
Recreate the failed resource for the Globally Distributed Autonomous
Database.
...
=====
   ...
   oci distributed-database distributed-autonomous-db-service distributed-autonomous-database recreate-failed-distributed-autonomous-database-resource [OPTIONS]
...
security policies before trying the examples.
       ...
       export resource_name=<substitute-value-of-resource_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/distributed-database/distributed-autonomous-db-service/distributed-autonomous-database/recreate-failed-distributed-autonomous-database-resource.html#cmdoption-resource-name
       ...
       oci distributed-database distributed-autonomous-db-service distributed-autonomous-database recreate-failed-distributed-autonomous-database-resource --distributed-autonomous-database-id $distributed_autonomous_database_id --resource-name $resource_name
