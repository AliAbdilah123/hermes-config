...
Query corresponding to the search operation. This query is parsed and
validated before execution and should follow the specification. For
more information on the query language specification, see Logging
...
Whether to return field schema information for the log stream
specified in searchQuery.
...
from the previous “Search” call. The input value can be null but an
empty string will return an error. For important details about how
