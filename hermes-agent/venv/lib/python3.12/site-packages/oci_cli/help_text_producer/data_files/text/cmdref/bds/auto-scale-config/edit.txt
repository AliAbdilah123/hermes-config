...
Updates fields on an autoscale configuration, including the name, the
threshold value, and whether the autoscale configuration is enabled.


Usage
=====

   oci bds auto-scale-config edit [OPTIONS]
...
security policies before trying the examples.
       ...
       export auto_scaling_configuration_id=<substitute-value-of-auto_scaling_configuration_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/bds/auto-scale-config/edit.html#cmdoption-auto-scaling-configuration-id
       export bds_instance_id=<substitute-value-of-bds_instance_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/bds/auto-scale-config/edit.html#cmdoption-bds-instance-id

       oci bds auto-scale-config edit --auto-scaling-configuration-id $auto_scaling_configuration_id --bds-instance-id $bds_instance_id
