...
Lists lifecycle stages that match the specified compartment or
lifecycle stage OCID. Filter the list against


Usage
=====

   oci os-management-hub lifecycle-stage list [OPTIONS]
...
A filter to return only lifecycle stages whose lifecycle state matches
...
security policies before trying the examples.
       ...
       oci os-management-hub lifecycle-stage list
