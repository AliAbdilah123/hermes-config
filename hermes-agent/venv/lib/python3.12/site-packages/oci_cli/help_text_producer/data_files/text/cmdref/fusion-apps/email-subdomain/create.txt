...
=====
   ...
   oci fusion-apps email-subdomain create [OPTIONS]
...
security policies before trying the examples.
       ...
       oci fusion-apps email-subdomain create --certificate-management $certificate_management --dns-management $dns_management --fusion-environment-id $fusion_environment_id --marketing-brand-id $marketing_brand_id --name $name
