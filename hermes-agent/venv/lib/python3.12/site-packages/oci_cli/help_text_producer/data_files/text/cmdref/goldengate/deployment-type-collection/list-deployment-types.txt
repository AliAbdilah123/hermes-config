...
=====
   ...
   oci goldengate deployment-type-collection list-deployment-types [OPTIONS]
...
The type of deployment, the value determines the exact ‘type’ of the
service executed in the deployment. Default value is DATABASE_ORACLE.
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/goldengate/deployment-type-collection/list-deployment-types.html#cmdoption-compartment-id

       oci goldengate deployment-type-collection list-deployment-types --compartment-id $compartment_id
