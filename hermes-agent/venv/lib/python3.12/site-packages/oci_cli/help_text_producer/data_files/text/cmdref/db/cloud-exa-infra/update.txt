...
Updates the Cloud Exadata infrastructure resource. Applies to Exadata
Cloud Service instances and Autonomous AI Database on dedicated
...
=====
   ...
   oci db cloud-exa-infra update [OPTIONS]
...
contact information (email addresses) for the specified OCI Database
service resource.
...
The user-friendly name for the cloud Exadata infrastructure. The name
...
--maintenance-version-preferences [complex type]
...
security policies before trying the examples.
       ...
       oci db cloud-exa-infra update --cloud-exa-infra-id $cloud_exa_infra_id
