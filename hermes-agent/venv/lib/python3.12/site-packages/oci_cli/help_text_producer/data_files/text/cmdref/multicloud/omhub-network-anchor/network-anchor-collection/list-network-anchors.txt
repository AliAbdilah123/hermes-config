...
Lists network anchors in the specified Multicloud subscription,
Multicloud compartment, and partner cloud region. Details listed for
each resource include name, state, VCN, and ODB network ID. For more
information, see Listing Network Anchors.
...
--network-anchor-lifecycle-state [text]
...
--should-fetch-vcn-name [boolean]

Whether to fetch and include the vcn display name, which may introduce
additional latency.
