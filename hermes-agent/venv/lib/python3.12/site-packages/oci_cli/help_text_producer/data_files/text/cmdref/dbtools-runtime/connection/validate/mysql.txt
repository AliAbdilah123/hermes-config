...
=====
   ...
   oci dbtools-runtime connection validate mysql [OPTIONS]
...
security policies before trying the examples.
       ...
       export connection_id=<substitute-value-of-connection_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools-runtime/connection/validate/mysql.html#cmdoption-connection-id

       oci dbtools-runtime connection validate mysql --connection-id $connection_id
