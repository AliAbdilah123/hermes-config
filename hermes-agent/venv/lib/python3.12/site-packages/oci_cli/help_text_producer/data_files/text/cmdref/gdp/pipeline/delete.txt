...
=====
   ...
   oci gdp pipeline delete [OPTIONS]
...
security policies before trying the examples.
       ...
       export gdp_pipeline_id=<substitute-value-of-gdp_pipeline_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/gdp/pipeline/delete.html#cmdoption-gdp-pipeline-id

       oci gdp pipeline delete --gdp-pipeline-id $gdp_pipeline_id
