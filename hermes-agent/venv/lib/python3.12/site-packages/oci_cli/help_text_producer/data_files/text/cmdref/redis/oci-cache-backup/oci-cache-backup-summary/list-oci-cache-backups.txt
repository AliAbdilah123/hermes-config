...
=====
   ...
   oci redis oci-cache-backup oci-cache-backup-summary list-oci-cache-backups [OPTIONS]
...
A filter to return the OCI Cache Backup resources, whose lifecycle
...
A filter to return the OCI Cache Backup resources, whose source
cluster ID matches with the given source cluster ID.
...
security policies before trying the examples.
       ...
       oci redis oci-cache-backup oci-cache-backup-summary list-oci-cache-backups
