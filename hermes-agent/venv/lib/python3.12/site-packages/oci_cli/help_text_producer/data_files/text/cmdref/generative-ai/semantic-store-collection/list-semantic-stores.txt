...
=====
   ...
   oci generative-ai semantic-store-collection list-semantic-stores [OPTIONS]
...
--data-source-querying-connection-id [text]

A filter to return only resources whose queryingConnectionId matches
with this id.
