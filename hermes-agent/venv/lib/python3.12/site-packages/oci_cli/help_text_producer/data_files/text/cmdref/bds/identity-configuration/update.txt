...
Update the IAM user sync and UPST configuration for the specified
...
=====
   ...
   oci bds identity-configuration update [OPTIONS]
...
--iam-user-sync-configuration-details [complex type]
...
--upst-configuration-details [complex type]
...
security policies before trying the examples.
       ...
       oci bds identity-configuration update --bds-instance-id $bds_instance_id --identity-configuration-id $identity_configuration_id
