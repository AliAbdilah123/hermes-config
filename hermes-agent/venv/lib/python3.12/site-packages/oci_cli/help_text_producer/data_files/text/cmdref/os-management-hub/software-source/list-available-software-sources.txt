"list-available-software-sources"
*********************************
...
Retrieves a list of software source repos that are available to add to
a specified compartment. This API returns repos that are not already
selected in the specified compartment.


Usage
=====

   oci os-management-hub software-source list-available-software-sources [OPTIONS]
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/os-management-hub/software-source/list-available-software-sources.html#cmdoption-compartment-id

       oci os-management-hub software-source list-available-software-sources --compartment-id $compartment_id
