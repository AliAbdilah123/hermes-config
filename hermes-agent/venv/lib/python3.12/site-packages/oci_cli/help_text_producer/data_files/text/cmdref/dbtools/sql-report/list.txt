...
=====
   ...
   oci dbtools sql-report list [OPTIONS]
...
*databaseToolsSqlReportLifecycleState* matches the specified
*databaseToolsSqlReportLifecycleState*.
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/sql-report/list.html#cmdoption-compartment-id

       oci dbtools sql-report list --compartment-id $compartment_id
