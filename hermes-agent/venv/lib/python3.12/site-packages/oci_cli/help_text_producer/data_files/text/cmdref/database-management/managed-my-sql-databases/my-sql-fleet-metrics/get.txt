...
Gets the health metrics for a fleet of MySQL Databases in a
compartment. MySQL support within OCI Database Management service has
...
--filter-by-mds-deployment-type [text]
...
--filter-by-my-sql-database-type-param [text]

The parameter to filter by MySQL database type. Allowed values are
EXTERNAL or MDS.
...
--filter-by-my-sql-database-version [text]

The parameter to filter by MySQL database version.

--filter-by-my-sql-deployment-type-param [text]
