...
=====
   ...
   oci dbtools-runtime execute-grantee delete [OPTIONS]
...
security policies before trying the examples.
       ...
       export connection_id=<substitute-value-of-connection_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools-runtime/execute-grantee/delete.html#cmdoption-connection-id
       export credential_key=<substitute-value-of-credential_key> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools-runtime/execute-grantee/delete.html#cmdoption-credential-key
       export execute_grantee_key=<substitute-value-of-execute_grantee_key> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools-runtime/execute-grantee/delete.html#cmdoption-execute-grantee-key

       oci dbtools-runtime execute-grantee delete --connection-id $connection_id --credential-key $credential_key --execute-grantee-key $execute_grantee_key
