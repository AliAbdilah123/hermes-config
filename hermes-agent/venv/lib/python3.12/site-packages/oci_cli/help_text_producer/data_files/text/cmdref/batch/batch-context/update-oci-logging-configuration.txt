"update-oci-logging-configuration"
**********************************
...
=====
   ...
   oci batch batch-context update-oci-logging-configuration [OPTIONS]
...
--logging-configuration-is-job-task-events-propagation-enabled [boolean]
...
security policies before trying the examples.
       ...
       export logging_configuration_is_job_task_events_propagation_enabled=<substitute-value-of-logging_configuration_is_job_task_events_propagation_enabled> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/batch/batch-context/update-oci-logging-configuration.html#cmdoption-logging-configuration-is-job-task-events-propagation-enabled
       ...
       oci batch batch-context update-oci-logging-configuration --batch-context-id $batch_context_id --logging-configuration-is-job-task-events-propagation-enabled $logging_configuration_is_job_task_events_propagation_enabled
