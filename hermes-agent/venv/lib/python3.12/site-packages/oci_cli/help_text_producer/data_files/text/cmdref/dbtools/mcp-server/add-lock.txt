...
=====
   ...
   oci dbtools mcp-server add-lock [OPTIONS]
...
security policies before trying the examples.
       ...
       export mcp_server_id=<substitute-value-of-mcp_server_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/mcp-server/add-lock.html#cmdoption-mcp-server-id
       export type=<substitute-value-of-type> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/mcp-server/add-lock.html#cmdoption-type

       oci dbtools mcp-server add-lock --mcp-server-id $mcp_server_id --type $type
