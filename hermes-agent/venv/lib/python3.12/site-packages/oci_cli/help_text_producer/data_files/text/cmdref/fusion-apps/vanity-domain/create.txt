...
=====
   ...
   oci fusion-apps vanity-domain create [OPTIONS]
...
Accepted values are:
   ...
   CUSTOMER_MANAGED, ORACLE_MANAGED
...
security policies before trying the examples.
       ...
       oci fusion-apps vanity-domain create --fusion-environment-id $fusion_environment_id
