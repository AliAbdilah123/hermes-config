"create-microsoft-sqlserver-connection"
***************************************
...
=====
   ...
   oci goldengate connection create-microsoft-sqlserver-connection [OPTIONS]
...
Server. This username must already exist and be available by the
Microsoft SQL Server to be connected to.
...
documentation on NameValuePair please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/goldengate/20200407/datatypes/NameValuePair. This is
...
us/iaas/api/#/en/goldengate/20200407/datatypes/AddResourceLockDetails.
This is a complex type whose value must be valid JSON. The value can
be provided as a string on the command line or passed in as a file
using the file://path/to/file syntax.
...
Microsoft SQL Server. Deprecated: This field is deprecated and
replaced by “passwordSecretId”. This field will be removed after
February 15 2026.

--password-secret-id [text]

The OCID of the Secret that stores the password Oracle GoldenGate uses
to connect the associated Microsoft SQL Server. Note: When provided,
‘password’ field must not be provided.
...
If set to true, the driver validates the certificate that is sent by
the database server.

--ssl-ca [text]

Database Certificate - The base64 encoded content of a .pem or .crt
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/goldengate/connection/create-microsoft-sqlserver-connection.html#cmdoption-compartment-id
       export database_name=<substitute-value-of-database_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/goldengate/connection/create-microsoft-sqlserver-connection.html#cmdoption-database-name
       export display_name=<substitute-value-of-display_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/goldengate/connection/create-microsoft-sqlserver-connection.html#cmdoption-display-name
       export host=<substitute-value-of-host> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/goldengate/connection/create-microsoft-sqlserver-connection.html#cmdoption-host
       export port=<substitute-value-of-port> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/goldengate/connection/create-microsoft-sqlserver-connection.html#cmdoption-port
       export security_protocol=<substitute-value-of-security_protocol> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/goldengate/connection/create-microsoft-sqlserver-connection.html#cmdoption-security-protocol
       export technology_type=<substitute-value-of-technology_type> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/goldengate/connection/create-microsoft-sqlserver-connection.html#cmdoption-technology-type
       export username=<substitute-value-of-username> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/goldengate/connection/create-microsoft-sqlserver-connection.html#cmdoption-username

       oci goldengate connection create-microsoft-sqlserver-connection --compartment-id $compartment_id --database-name $database_name --display-name $display_name --host $host --port $port --security-protocol $security_protocol --technology-type $technology_type --username $username
