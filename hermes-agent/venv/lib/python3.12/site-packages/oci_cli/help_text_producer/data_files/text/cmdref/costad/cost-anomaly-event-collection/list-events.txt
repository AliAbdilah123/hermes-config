...
=====
   ...
   oci costad cost-anomaly-event-collection list-events [OPTIONS]
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/costad/cost-anomaly-event-collection/list-events.html#cmdoption-compartment-id

       oci costad cost-anomaly-event-collection list-events --compartment-id $compartment_id
