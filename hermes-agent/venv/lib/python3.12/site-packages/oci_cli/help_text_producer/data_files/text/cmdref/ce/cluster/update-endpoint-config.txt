...
=====
   ...
   oci ce cluster update-endpoint-config [OPTIONS]
...
to false. If set to true on a private subnet, the cluster update will
fail.
...
the cluster endpoint. For more information about NSGs, see
...
Security attributes are labels         for a resource that can be
referenced in a Zero Trust Packet Routing         (ZPR) policy to
control access to ZPR-supported resources. This is a complex type
...
security policies before trying the examples.
       ...
       oci ce cluster update-endpoint-config --cluster-id $cluster_id
