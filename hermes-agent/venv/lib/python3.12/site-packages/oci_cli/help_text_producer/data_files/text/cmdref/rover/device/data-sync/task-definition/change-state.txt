...
Change TaskDefinition State


Usage
=====

   oci rover device data-sync task-definition change-state [OPTIONS]
...
Set whether task definition enablement to true or false.

--task-definition-id [text]

Change the Task Definition specified by its ocid.
...
security policies before trying the examples.
       ...
       export is_enabled=<substitute-value-of-is_enabled> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/rover/device/data-sync/task-definition/change-state.html#cmdoption-is-enabled
       ...
       oci rover device data-sync task-definition change-state --is-enabled $is_enabled --task-definition-id $task_definition_id
