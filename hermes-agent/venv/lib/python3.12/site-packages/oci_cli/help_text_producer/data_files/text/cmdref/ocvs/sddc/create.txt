...
Accepted values are:
   ...
   ADVANCED, DISABLED, ENTERPRISE

--initial-configuration [complex type]
...
security policies before trying the examples.
       ...
       oci ocvs sddc create --compartment-id $compartment_id --hcx-mode $hcx_mode --initial-configuration file://initial-configuration.json --ssh-authorized-keys $ssh_authorized_keys --vmware-version $vmware_version
