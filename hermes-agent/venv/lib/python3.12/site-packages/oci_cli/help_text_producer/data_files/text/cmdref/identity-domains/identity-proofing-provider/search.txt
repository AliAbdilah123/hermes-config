...
=====
   ...
   oci identity-domains identity-proofing-provider search [OPTIONS]
...
parameter is also available, union of the two is fetched. Valid
values: all, always, never, request, default. Values are case-
...
example parameters with your own.
       ...
       oci identity-domains identity-proofing-provider search --generate-param-json-input schemas > schemas.json
...
security policies before trying the examples.
       ...
       oci identity-domains identity-proofing-provider search --schemas file://schemas.json
