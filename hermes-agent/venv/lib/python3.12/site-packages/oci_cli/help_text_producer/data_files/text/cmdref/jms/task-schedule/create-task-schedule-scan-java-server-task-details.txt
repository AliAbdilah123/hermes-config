"create-task-schedule-scan-java-server-task-details"
****************************************************
...
=====
   ...
   oci jms task-schedule create-task-schedule-scan-java-server-task-details [OPTIONS]
...
security policies before trying the examples.
       ...
       export execution_recurrences=<substitute-value-of-execution_recurrences> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/jms/task-schedule/create-task-schedule-scan-java-server-task-details.html#cmdoption-execution-recurrences
       ...
       oci jms task-schedule create-task-schedule-scan-java-server-task-details --execution-recurrences $execution_recurrences --fleet-id $fleet_id
