"validate-and-configure-microsite-dns"
**************************************
...
=====
   ...
   oci fusion-apps microsite validate-and-configure-microsite-dns [OPTIONS]
...
security policies before trying the examples.
       ...
       export fusion_environment_id=<substitute-value-of-fusion_environment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fusion-apps/microsite/create.html#cmdoption-fusion-environment-id
       export name=<substitute-value-of-name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fusion-apps/microsite/create.html#cmdoption-name
       export certificate_management=<substitute-value-of-certificate_management> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fusion-apps/microsite/create.html#cmdoption-certificate-management
       export dns_management=<substitute-value-of-dns_management> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fusion-apps/microsite/create.html#cmdoption-dns-management
       export marketing_brand_id=<substitute-value-of-marketing_brand_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fusion-apps/microsite/create.html#cmdoption-marketing-brand-id
       ...
       microsite_id=$(oci fusion-apps microsite create --certificate-management $certificate_management --dns-management $dns_management --fusion-environment-id $fusion_environment_id --marketing-brand-id $marketing_brand_id --name $name --query data.id --raw-output)

       oci fusion-apps microsite validate-and-configure-microsite-dns --fusion-environment-id $fusion_environment_id --marketing-brand-id $marketing_brand_id --microsite-id $microsite_id
