...
=====
   ...
   oci multicloud multicloud-policies multicloud-policy-collection list-multicloud-policies [OPTIONS]
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/multicloud/multicloud-policies/multicloud-policy-collection/list-multicloud-policies.html#cmdoption-compartment-id

       oci multicloud multicloud-policies multicloud-policy-collection list-multicloud-policies --compartment-id $compartment_id
