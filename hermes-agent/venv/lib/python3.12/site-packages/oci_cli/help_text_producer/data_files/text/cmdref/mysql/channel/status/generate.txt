...
=====
   ...
   oci mysql channel status generate [OPTIONS]
...
security policies before trying the examples.
       ...
       export channel_id=<substitute-value-of-channel_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/mysql/channel/status/generate.html#cmdoption-channel-id

       oci mysql channel status generate --channel-id $channel_id
