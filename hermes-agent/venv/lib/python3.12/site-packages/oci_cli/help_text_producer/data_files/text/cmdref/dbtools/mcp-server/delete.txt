...
=====
   ...
   oci dbtools mcp-server delete [OPTIONS]
...
security policies before trying the examples.
       ...
       export mcp_server_id=<substitute-value-of-mcp_server_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/mcp-server/delete.html#cmdoption-mcp-server-id

       oci dbtools mcp-server delete --mcp-server-id $mcp_server_id
