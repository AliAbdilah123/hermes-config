...
=====
   ...
   oci fusion-apps vanity-domain list [OPTIONS]
...
security policies before trying the examples.
       ...
       export is_full_vanity_domain=<substitute-value-of-is_full_vanity_domain> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fusion-apps/vanity-domain/list.html#cmdoption-is-full-vanity-domain
       ...
       oci fusion-apps vanity-domain list --compartment-id $compartment_id --fusion-environment-id $fusion_environment_id --is-full-vanity-domain $is_full_vanity_domain
