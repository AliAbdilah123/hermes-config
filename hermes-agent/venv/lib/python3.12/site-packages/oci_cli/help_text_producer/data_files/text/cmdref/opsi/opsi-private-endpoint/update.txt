...
=====
   ...
   oci opsi opsi-private-endpoint update [OPTIONS]
...
The OCID of the network security groups that the Private service
accessed the database. This is a complex type whose value must be
...
security policies before trying the examples.
       ...
       oci opsi opsi-private-endpoint update --opsi-private-endpoint-id $opsi_private_endpoint_id
