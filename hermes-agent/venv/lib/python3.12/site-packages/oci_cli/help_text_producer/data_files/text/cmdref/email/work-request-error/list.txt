...
=====
   ...
   oci email work-request-error list [OPTIONS]
...
security policies before trying the examples.
       ...
       export work_request_id=<substitute-value-of-work_request_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/email/work-request-error/list.html#cmdoption-work-request-id

       oci email work-request-error list --work-request-id $work_request_id
