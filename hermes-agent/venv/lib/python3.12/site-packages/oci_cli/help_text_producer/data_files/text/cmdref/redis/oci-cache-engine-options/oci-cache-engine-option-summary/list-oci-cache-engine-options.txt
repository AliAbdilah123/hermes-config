...
=====
   ...
   oci redis oci-cache-engine-options oci-cache-engine-option-summary list-oci-cache-engine-options [OPTIONS]
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/redis/oci-cache-engine-options/oci-cache-engine-option-summary/list-oci-cache-engine-options.html#cmdoption-compartment-id

       oci redis oci-cache-engine-options oci-cache-engine-option-summary list-oci-cache-engine-options --compartment-id $compartment_id
