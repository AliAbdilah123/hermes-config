...
Start public api endpoint decommission for a cluster, legacy
kubernetes endpoint will no longer available after this operation.


Usage
=====

   oci ce cluster start-public-api-endpoint-decommission [OPTIONS]
...
security policies before trying the examples.
       ...
       oci ce cluster start-public-api-endpoint-decommission --cluster-id $cluster_id
