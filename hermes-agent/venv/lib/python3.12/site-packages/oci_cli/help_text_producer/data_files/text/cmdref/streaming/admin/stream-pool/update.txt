...
=====
   ...
   oci streaming admin stream-pool update [OPTIONS]
...
security policies before trying the examples.
       ...
       stream_pool_id=$(oci streaming admin stream-pool create --compartment-id $compartment_id --name $name --query data.id --raw-output)

       oci streaming admin stream-pool update --stream-pool-id $stream_pool_id
