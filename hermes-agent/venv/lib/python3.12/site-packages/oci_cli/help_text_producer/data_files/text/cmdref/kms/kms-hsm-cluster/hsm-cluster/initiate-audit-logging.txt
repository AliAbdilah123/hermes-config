...
Initiates the process of enabling audit logs for a HSM cluster
resource by taking in the required parameters.


Usage
=====

   oci kms kms-hsm-cluster hsm-cluster initiate-audit-logging [OPTIONS]
...
security policies before trying the examples.
       ...
       export bucket_name=<substitute-value-of-bucket_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/kms/kms-hsm-cluster/hsm-cluster/initiate-audit-logging.html#cmdoption-bucket-name
       export namespace=<substitute-value-of-namespace> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/kms/kms-hsm-cluster/hsm-cluster/initiate-audit-logging.html#cmdoption-namespace
       ...
       oci kms kms-hsm-cluster hsm-cluster initiate-audit-logging --bucket-name $bucket_name --compartment-id $compartment_id --hsm-cluster-id $hsm_cluster_id --namespace $namespace
