...
=====
   ...
   oci fusion-apps vanity-domain upload-vanity-domain-certificate [OPTIONS]
...
security policies before trying the examples.
       ...
       export fusion_environment_id=<substitute-value-of-fusion_environment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fusion-apps/vanity-domain/create.html#cmdoption-fusion-environment-id
       export certificate_pem=<substitute-value-of-certificate_pem> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fusion-apps/vanity-domain/upload-vanity-domain-certificate.html#cmdoption-certificate-pem
       export common_name=<substitute-value-of-common_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fusion-apps/vanity-domain/upload-vanity-domain-certificate.html#cmdoption-common-name
       export is_akamai=<substitute-value-of-is_akamai> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fusion-apps/vanity-domain/upload-vanity-domain-certificate.html#cmdoption-is-akamai
       ...
       vanity_domain_id=$(oci fusion-apps vanity-domain create --fusion-environment-id $fusion_environment_id --query data.id --raw-output)

       oci fusion-apps vanity-domain upload-vanity-domain-certificate --certificate-pem $certificate_pem --common-name $common_name --fusion-environment-id $fusion_environment_id --is-akamai $is_akamai --vanity-domain-id $vanity_domain_id
