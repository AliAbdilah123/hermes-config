...
=====
   ...
   oci dbtools mcp-server list [OPTIONS]
...
A filter to return only resources when their
*databaseToolsConnectionId* matches the specified
...
*databaseToolsMcpServerLifecycleState* matches the specified
*databaseToolsMcpServerLifecycleState*.
...
--related-resource-identifier [text]
...
A filter to return only resources with one of the specified type
values.
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/mcp-server/list.html#cmdoption-compartment-id

       oci dbtools mcp-server list --compartment-id $compartment_id
