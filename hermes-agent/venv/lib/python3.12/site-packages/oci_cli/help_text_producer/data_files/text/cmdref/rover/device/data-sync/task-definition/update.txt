...
=====
   ...
   oci rover device data-sync task-definition update [OPTIONS]
...
The ocid of the Task Definition to be updated.
...
Provide the details about the destination datastore in JSON structure
either in-line or via a local file, file://path-to/data-sync-
destination-json-file.

--edge-type [text]

If provided, it sets the target path to either a Rover RED or PCA
device. (red/pca)
...
If provided, it sets the data transfer rate limit for this task.
Allowed values are 50M, 100M, 250M, 500M, 1G, 2G, or 5G. Default to
unlimited if not provided.

--schedule [complex type]

Provide the details about how the task execution is scheduled in JSON
structure either in-line or via a local file, file://path-to/schedule-
json-file.

--source [complex type]

Provide the details about the source datastore in JSON structure
either in-line or via a local file, file://path-to/data-sync-source-
json-file.
...
security policies before trying the examples.
       ...
       oci rover device data-sync task-definition update --task-definition-id $task_definition_id
