...
Updates the ApplicationGroup with the given name in the network
firewall policy.
...
=====
   ...
   oci network-firewall application-group update [OPTIONS]


Required Parameters
===================

--application-group-name [text]

Unique name identifier for Application Lists in the scope of Network
Firewall Policy.
...
Collection of application names. This is a complex type whose value
...
The description of the application list. This field can be used to add
additional info.
...
security policies before trying the examples.
       ...
       export application_group_name=<substitute-value-of-application_group_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network-firewall/application-group/update.html#cmdoption-application-group-name
       ...
       oci network-firewall application-group update --application-group-name $application_group_name --network-firewall-policy-id $network_firewall_policy_id
