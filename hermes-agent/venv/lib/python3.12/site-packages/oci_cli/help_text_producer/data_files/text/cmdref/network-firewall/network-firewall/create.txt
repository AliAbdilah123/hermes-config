...
=====
   ...
   oci network-firewall network-firewall create [OPTIONS]
...
Availability Domain where Network Firewall instance is created. To get
a list of availability domains for a tenancy, use
ListAvailabilityDomains operation. Example: *kIdk:PHX-AD-1*
...
A user-friendly name for the Network Firewall. Does not have to be
...
--nat-configuration [complex type]
...
An array of network security groups OCID associated with the Network
Firewall. This is a complex type whose value must be valid JSON. The
...
The shape of a firewall to determine the bandwidth that the firewall
allows.
...
security policies before trying the examples.
       ...
       oci network-firewall network-firewall create --compartment-id $compartment_id --network-firewall-policy-id $network_firewall_policy_id --subnet-id $subnet_id
