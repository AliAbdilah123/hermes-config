...
Refresh confidential application for the given identity configuration
in case of any update to the confidential application (e.g.
...
=====
   ...
   oci bds identity-configuration refresh-confidential-application [OPTIONS]
...
security policies before trying the examples.
       ...
       oci bds identity-configuration refresh-confidential-application --bds-instance-id $bds_instance_id --identity-configuration-id $identity_configuration_id
