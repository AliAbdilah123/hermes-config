...
=====
   ...
   oci fusion-apps microsite update [OPTIONS]
...
--wait-for-state" ACTIVE "--wait-for-state" INACTIVE would return on
...
security policies before trying the examples.
       ...
       oci fusion-apps microsite update --fusion-environment-id $fusion_environment_id --marketing-brand-id $marketing_brand_id --microsite-id $microsite_id
