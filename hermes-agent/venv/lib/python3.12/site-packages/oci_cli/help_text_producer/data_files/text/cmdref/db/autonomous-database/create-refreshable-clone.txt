...
security policies before trying the examples.
       ...
       export db_name=<substitute-value-of-db_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/autonomous-database/create-refreshable-clone.html#cmdoption-db-name
       ...
       oci db autonomous-database create-refreshable-clone --compartment-id $compartment_id --db-name $db_name --source-id $source_id
