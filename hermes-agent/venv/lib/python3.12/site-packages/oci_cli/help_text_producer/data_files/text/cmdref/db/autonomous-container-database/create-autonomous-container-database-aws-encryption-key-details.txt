...
=====
   ...
   oci db autonomous-container-database create-autonomous-container-database-aws-encryption-key-details [OPTIONS]
...
--encryption-key-location-details-aws-encryption-key-id [text]
...
security policies before trying the examples.
       ...
       export display_name=<substitute-value-of-display_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/autonomous-container-database/create-autonomous-container-database-aws-encryption-key-details.html#cmdoption-display-name
       export encryption_key_location_details_aws_encryption_key_id=<substitute-value-of-encryption_key_location_details_aws_encryption_key_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/autonomous-container-database/create-autonomous-container-database-aws-encryption-key-details.html#cmdoption-encryption-key-location-details-aws-encryption-key-id
       export patch_model=<substitute-value-of-patch_model> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/autonomous-container-database/create-autonomous-container-database-aws-encryption-key-details.html#cmdoption-patch-model

       oci db autonomous-container-database create-autonomous-container-database-aws-encryption-key-details --display-name $display_name --encryption-key-location-details-aws-encryption-key-id $encryption_key_location_details_aws_encryption_key_id --patch-model $patch_model
