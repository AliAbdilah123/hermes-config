...
=====
   ...
   oci network-firewall application-group create [OPTIONS]
...
security policies before trying the examples.
       ...
       export name=<substitute-value-of-name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network-firewall/application-group/create.html#cmdoption-name
       ...
       oci network-firewall application-group create --name $name --network-firewall-policy-id $network_firewall_policy_id
