...
Lists management stations within the specified compartment. Filter the
list against a variety of criteria including but not limited to name,
status, and location.
...
=====
   ...
   oci os-management-hub management-station list [OPTIONS]
...
A filter that returns information for management stations in the
specified health state.

Accepted values are:

   HEALTHY, UNAVAILABLE, UNHEALTHY
...
security policies before trying the examples.
       ...
       oci os-management-hub management-station list
