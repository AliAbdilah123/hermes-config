...
--log-compartment-id [text]

The identifier of the log group compartment used with the SQL
Endpoint.

--log-display-name [text]
...
--log-retention-duration [integer]
