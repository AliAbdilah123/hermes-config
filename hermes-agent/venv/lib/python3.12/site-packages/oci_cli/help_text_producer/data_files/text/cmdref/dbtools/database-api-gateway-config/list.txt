...
=====
   ...
   oci dbtools database-api-gateway-config list [OPTIONS]
...
A filter to return resources only when their *lifecycleState* matches
the specified *lifecycleState*.
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/database-api-gateway-config/list.html#cmdoption-compartment-id

       oci dbtools database-api-gateway-config list --compartment-id $compartment_id
