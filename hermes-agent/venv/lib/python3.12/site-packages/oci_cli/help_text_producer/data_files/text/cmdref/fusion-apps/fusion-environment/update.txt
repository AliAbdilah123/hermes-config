...
=====
   ...
   oci fusion-apps fusion-environment update [OPTIONS]
...
Network access control rules to limit internet traffic that can access
the environment. For more information, see AllowRule Reference.
...
security policies before trying the examples.
       ...
       oci fusion-apps fusion-environment update --fusion-environment-id $fusion_environment_id
