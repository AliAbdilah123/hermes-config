...
=====
   ...
   oci multicloud multicloud-alerts multicloud-alert-collection list-multicloud-alerts [OPTIONS]
...
--alert-function-name [text]

Filter alerts generated by a specific internal component (e.g. MCL,
BILLING, ORP).

--alert-status [text]

Filter alerts by alert status. User interaction: ACKNOWLEDGED,
UNACKNOWLEDGED System lifecycle: RESOLVED

Accepted values are:

   ACKNOWLEDGED, RESOLVED, UNACKNOWLEDGED
...
(*DESC*). In general, the sort order is *DESC* when sorting by time
and *ASC* otherwise.
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/multicloud/multicloud-alerts/multicloud-alert-collection/list-multicloud-alerts.html#cmdoption-compartment-id

       oci multicloud multicloud-alerts multicloud-alert-collection list-multicloud-alerts --compartment-id $compartment_id
