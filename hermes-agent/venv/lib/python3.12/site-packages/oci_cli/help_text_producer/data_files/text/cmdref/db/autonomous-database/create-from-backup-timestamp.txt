...
Autonomous AI Database. The timestamp must be in the past.
...
--use-latest-available-backup-time-stamp [boolean]
...
security policies before trying the examples.
       ...
       oci db autonomous-database create-from-backup-timestamp --autonomous-database-id $autonomous_database_id --clone-type $clone_type --compartment-id $compartment_id --db-name $db_name
