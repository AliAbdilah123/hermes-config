"move-distributed-database-replication-unit"
********************************************
...
=====
   ...
   oci distributed-database distributed-db-service distributed-database move-distributed-database-replication-unit [OPTIONS]


Required Parameters
===================

--distributed-database-id [text]
...
security policies before trying the examples.
       ...
       export source_shard_name=<substitute-value-of-source_shard_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/distributed-database/distributed-db-service/distributed-database/move-distributed-database-replication-unit.html#cmdoption-source-shard-name
       ...
       oci distributed-database distributed-db-service distributed-database move-distributed-database-replication-unit --distributed-database-id $distributed_database_id --source-shard-name $source_shard_name
