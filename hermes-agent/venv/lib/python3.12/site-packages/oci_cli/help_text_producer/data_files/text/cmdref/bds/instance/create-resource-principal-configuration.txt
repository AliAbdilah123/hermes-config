...
--session-token-life-span-duration-in-hours [integer]
...
security policies before trying the examples.
       ...
       export bds_instance_id=<substitute-value-of-bds_instance_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/bds/instance/create-resource-principal-configuration.html#cmdoption-bds-instance-id
       export display_name=<substitute-value-of-display_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/bds/instance/create-resource-principal-configuration.html#cmdoption-display-name

       oci bds instance create-resource-principal-configuration --bds-instance-id $bds_instance_id --display-name $display_name
