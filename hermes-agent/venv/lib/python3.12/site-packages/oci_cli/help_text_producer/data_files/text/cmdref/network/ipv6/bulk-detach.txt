...
=====
   ...
   oci network ipv6 bulk-detach [OPTIONS]


Required Parameters
===================

--bulk-detach-ipv6s-item [complex type]

A secondary IPv6 address to detach. This is a complex type whose value
...
The OCID of the VNIC from which multiple IPv6s should be detached. The
VNIC and IPv6s must be in the same subnet.
...
example parameters with your own.
       ...
       oci network ipv6 bulk-detach --generate-param-json-input bulk-detach-ipv6s-item > bulk-detach-ipv6s-item.json
...
security policies before trying the examples.
       ...
       oci network ipv6 bulk-detach --bulk-detach-ipv6s-item file://bulk-detach-ipv6s-item.json
