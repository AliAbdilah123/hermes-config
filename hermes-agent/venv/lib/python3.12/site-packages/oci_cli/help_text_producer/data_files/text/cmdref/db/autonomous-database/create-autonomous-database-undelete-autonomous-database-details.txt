...
=====
   ...
   oci db autonomous-database create-autonomous-database-undelete-autonomous-database-details [OPTIONS]
...
The OCID of the Autonomous AI Database that you want to undelete.
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/autonomous-database/create-autonomous-database-undelete-autonomous-database-details.html#cmdoption-compartment-id
       export source_id=<substitute-value-of-source_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/autonomous-database/create-autonomous-database-undelete-autonomous-database-details.html#cmdoption-source-id

       oci db autonomous-database create-autonomous-database-undelete-autonomous-database-details --compartment-id $compartment_id --source-id $source_id
