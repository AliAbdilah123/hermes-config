...
The OCID of the source Autonomous AI Database that you will clone to
create a new Autonomous AI Database.
...
Clones an Autonomous Database Serverless with minimal parameters.


Command
-------

    oci db autonomous-database create-from-clone --clone-type FULL --source-id $sourceId --compute-model ECPU --compute-count 4 --data-storage-size-in-gbs 20 --admin-password $password --compartment-id $compartment --db-version 19c --db-name myTestDb
...
------

   {
    "data": {
         ...
         "encryption-key-history-entry": "null",
         "failed-data-recovery-in-seconds": "null",
         "freeform-tags": {},
         "id": "ocid1.autonomousdatabase.oc1.iad....",
         ...
         "is-oracle-service-gateway-allowed": false,
         "is-preview": false,
         "is-reconnect-clone-enabled": "null",
         "is-refreshable-clone": "null",
         "is-registered-as-customer-owned-container": false,
         "is-remote-data-guard-enabled": false,
         "is-virtual-clone": "null",
         ...
         "source-id": "ocid1.autonomousdatabase....",
         "standby-db": "null",
         "standby-whitelisted-ips": "null",
         "subnet-id": "null",
         "supported-regions-to-clone-to": "null",
         "system-tags": {},
         "time-created": "2024-07-03T23:22:57.803000+00:00",
