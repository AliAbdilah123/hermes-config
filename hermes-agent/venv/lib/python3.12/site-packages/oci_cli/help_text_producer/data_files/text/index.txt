...
* Database Tools Runtime (dbtools-runtime)
...
* Generative AI Service NL2SQL (generative-ai-data)

* Globally Distributed Database (distributed-database)

* GoldenGate (goldengate)

* GovernanceRulesControlPlane (governance-rules-control-plane)

* Guarded Data Pipelines (gdp)
...
* Java Management Service Java Download (jms-java-downloads)

* Java Management Service Utilities (jms-utils)
...
* Limits Increase (limits-increase)
...
* Model Deployment Data Plane (model-deployment)
...
* OneSubscription Gateway  Organization’s Subscription (osub-
...
* Oracle  Access Control (apiaccesscontrol)
...
* Oracle Multicloud (multicloud)

* Oracle Streaming with Apache Kafka (OSAK) (kafka)
...
* P Control Plane (api-platform)

* PGSQL Control Plane (psql)

* PrivateServiceAccess Control Plane (psa)
...
* WebLogic Management Service (wlms)
