...
=====
   ...
   oci bds identity-configuration deactivate-iam-user-sync-configuration [OPTIONS]
...
security policies before trying the examples.
       ...
       oci bds identity-configuration deactivate-iam-user-sync-configuration --bds-instance-id $bds_instance_id --identity-configuration-id $identity_configuration_id
