...
utilization percent, base capacity, isAutoScalingEnabled) for each
database filtered by utilization level in a compartment and in all
...
=====
   ...
   oci opsi database-insights summarize-database-insight-resource-statistics [OPTIONS]
