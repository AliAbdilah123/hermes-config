...
Returns a recommended Scheduled Actions configuration for a given
resource, plan intent and scheduling policy.


Usage
=====

   oci db recommended-scheduled-action-summary list-recommended-scheduled-actions [OPTIONS]
...
Accepted values are:
   ...
   EXADATA_INFRASTRUCTURE_FULL_SOFTWARE_UPDATE, EXADATA_INFRASTRUCTURE_SECURITY_UPDATE

--scheduling-policy-id [text]

The Scheduling Policy OCID.

--scheduling-policy-target-resource-id [text]
...
security policies before trying the examples.
       ...
       export plan_intent=<substitute-value-of-plan_intent> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/recommended-scheduled-action-summary/list-recommended-scheduled-actions.html#cmdoption-plan-intent
       export scheduling_policy_target_resource_id=<substitute-value-of-scheduling_policy_target_resource_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/recommended-scheduled-action-summary/list-recommended-scheduled-actions.html#cmdoption-scheduling-policy-target-resource-id
       ...
       oci db recommended-scheduled-action-summary list-recommended-scheduled-actions --plan-intent $plan_intent --scheduling-policy-id $scheduling_policy_id --scheduling-policy-target-resource-id $scheduling_policy_target_resource_id
