...
user. Not required if the secretId is specified.
...
security policies before trying the examples.
       ...
       oci bds instance create --cluster-public-key $cluster_public_key --cluster-version $cluster_version --compartment-id $compartment_id --display-name $display_name --is-high-availability $is_high_availability --is-secure $is_secure --nodes file://nodes.json
