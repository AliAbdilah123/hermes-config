...
=====
   ...
   oci email email-ip-pool create [OPTIONS]
...
The name of the IpPool. The name must be unique within a region. The
name is case sensitive and supported characters include alphanumeric,
...
--outbound-ips [complex type]

A list of outbound public IPs for assignment to the IpPool. These IPs
must be in the AVAILABLE state to be eligible for assignment. This is
...
--last-ip-drain-period [integer]

Last IP will be unassigned from the IP Pool after the period of time
(in hours) specified by this parameter. Default is 24 hours.
...
security policies before trying the examples.
       ...
       oci email email-ip-pool create --compartment-id $compartment_id --name $name --outbound-ips file://outbound-ips.json
