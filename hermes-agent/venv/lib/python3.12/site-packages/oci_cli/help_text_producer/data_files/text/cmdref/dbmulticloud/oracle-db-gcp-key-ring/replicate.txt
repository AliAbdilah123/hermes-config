...
=====
   ...
   oci dbmulticloud oracle-db-gcp-key-ring replicate [OPTIONS]
...
security policies before trying the examples.
       ...
       export target_region=<substitute-value-of-target_region> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbmulticloud/oracle-db-gcp-key-ring/replicate.html#cmdoption-target-region
       ...
       oci dbmulticloud oracle-db-gcp-key-ring replicate --oracle-db-gcp-key-ring-id $oracle_db_gcp_key_ring_id --target-region $target_region
