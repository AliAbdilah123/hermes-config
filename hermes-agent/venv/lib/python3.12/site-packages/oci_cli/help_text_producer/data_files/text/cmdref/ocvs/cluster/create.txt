...
=====
   ...
   oci ocvs cluster create [OPTIONS]
...
--datastore-cluster-ids [complex type]

A list of datastore clusters. This is a complex type whose value must
...
documentation on DatastoreInfo please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/cluster/20230701/datatypes/DatastoreInfo. This is a
...
A descriptive name for the Cluster. Cluster name requirements are 1-22
...
--initial-vcf-byol-allocation-id [text]

The OCID of the initial VMware BYOL Allocation used to deploy VMware
Cloud Foundation.
...
security policies before trying the examples.
       ...
       oci ocvs cluster create --compute-availability-domain $compute_availability_domain --esxi-hosts-count $esxi_hosts_count --network-configuration file://network-configuration.json --sddc-id $sddc_id
