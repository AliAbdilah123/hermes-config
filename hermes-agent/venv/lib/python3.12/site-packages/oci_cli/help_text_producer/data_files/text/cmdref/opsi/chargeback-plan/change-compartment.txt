...
Moves a Chargeback Plan insight resource from one compartment
identifier to another. When provided, If-Match is checked against ETag
...
=====
   ...
   oci opsi chargeback-plan change-compartment [OPTIONS]


Required Parameters
===================

--chargebackplan-id [text]
...
security policies before trying the examples.
       ...
       export chargebackplan_id=<substitute-value-of-chargebackplan_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/opsi/chargeback-plan/change-compartment.html#cmdoption-chargebackplan-id
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/opsi/chargeback-plan/change-compartment.html#cmdoption-compartment-id

       oci opsi chargeback-plan change-compartment --chargebackplan-id $chargebackplan_id --compartment-id $compartment_id
