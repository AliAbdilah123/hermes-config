...
Lists software sources that match the specified tenancy or software
source OCID. Filter the list against a variety of criteria including
but not limited to its name, status, architecture, and OS family.


Usage
=====

   oci os-management-hub software-source list [OPTIONS]
...
--display-name-ne [text]

A multi filter to return resources that do not contains the given
display names.
...
--is-mandatory-for-alx [boolean]

Indicates whether the software source is mandatory for the Autonomous
Linux service.

--is-mirror-sync-allowed [boolean]

A filter to return software sources which can be synced to a
management station.
...
security policies before trying the examples.
       ...
       oci os-management-hub software-source list
