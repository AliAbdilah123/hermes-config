...
=====
   ...
   oci generative-ai vector-store-connector-collection list-vector-store-connectors [OPTIONS]
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/generative-ai/vector-store-connector-collection/list-vector-store-connectors.html#cmdoption-compartment-id

       oci generative-ai vector-store-connector-collection list-vector-store-connectors --compartment-id $compartment_id
