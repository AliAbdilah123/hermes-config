...
=====
   ...
   oci goldengate connection update-google-big-query-connection [OPTIONS]
...
security policies before trying the examples.
       ...
       export connection_id=<substitute-value-of-connection_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/goldengate/connection/update-google-big-query-connection.html#cmdoption-connection-id

       oci goldengate connection update-google-big-query-connection --connection-id $connection_id
