...
Lists lifecycle environments that match the specified compartment or
lifecycle environment OCID. Filter the list against a variety of
criteria including but not limited to its name, status, architecture,
and OS family.
...
=====
   ...
   oci os-management-hub lifecycle-environment list [OPTIONS]
...
A filter to return only the lifecycle environments that match the
display name given.
...
security policies before trying the examples.
       ...
       oci os-management-hub lifecycle-environment list
