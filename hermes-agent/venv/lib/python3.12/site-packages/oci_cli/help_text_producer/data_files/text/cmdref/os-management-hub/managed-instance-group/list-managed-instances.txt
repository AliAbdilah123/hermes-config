...
Lists all managed instances for a specified managed instance group.
Filter the list against a variety of criteria including but not
limited to the managed instance name. The results list all managed
instances that have already been added to the group.


Usage
=====

   oci os-management-hub managed-instance-group list-managed-instances [OPTIONS]
...
security policies before trying the examples.
       ...
       export group_id=<substitute-value-of-group_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/os-management-hub/managed-instance-group/list-managed-instances.html#cmdoption-group-id

       oci os-management-hub managed-instance-group list-managed-instances --group-id $group_id
