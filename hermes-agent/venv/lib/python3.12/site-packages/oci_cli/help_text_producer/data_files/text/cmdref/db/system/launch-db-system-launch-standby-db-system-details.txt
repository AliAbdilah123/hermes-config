"launch-db-system-launch-standby-db-system-details"
***************************************************
...
=====
   ...
   oci db system launch-db-system-launch-standby-db-system-details [OPTIONS]
...
--storage-volume-performance-mode [text]
...
--wait-for-state" PROVISIONING "--wait-for-state" UPGRADING would
...
example parameters with your own.
       ...
       oci db system launch-db-system-launch-standby-db-system-details --generate-param-json-input db-home > db-home.json
       oci db system launch-db-system-launch-standby-db-system-details --generate-param-json-input ssh-public-keys > ssh-public-keys.json
...
security policies before trying the examples.
       ...
       export availability_domain=<substitute-value-of-availability_domain> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/system/launch-db-system-launch-standby-db-system-details.html#cmdoption-availability-domain
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/system/launch-db-system-launch-standby-db-system-details.html#cmdoption-compartment-id
       export hostname=<substitute-value-of-hostname> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/system/launch-db-system-launch-standby-db-system-details.html#cmdoption-hostname
       export primary_db_system_id=<substitute-value-of-primary_db_system_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/system/launch-db-system-launch-standby-db-system-details.html#cmdoption-primary-db-system-id
       export shape=<substitute-value-of-shape> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/system/launch-db-system-launch-standby-db-system-details.html#cmdoption-shape
       export subnet_id=<substitute-value-of-subnet_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/system/launch-db-system-launch-standby-db-system-details.html#cmdoption-subnet-id

       db_home_id=$(oci db db-home create --db-system-id $db_system_id --query data.id --raw-output)

       oci db system launch-db-system-launch-standby-db-system-details --availability-domain $availability_domain --compartment-id $compartment_id --db-home file://db-home.json --hostname $hostname --primary-db-system-id $primary_db_system_id --shape $shape --ssh-public-keys file://ssh-public-keys.json --subnet-id $subnet_id
