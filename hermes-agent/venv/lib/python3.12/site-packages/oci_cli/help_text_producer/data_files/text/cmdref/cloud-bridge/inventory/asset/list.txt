...
=====
   ...
   oci cloud-bridge inventory asset list [OPTIONS]
...
A filter to return only assets whose lifecycleState matches the given
lifecycleState.
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/cloud-bridge/inventory/asset/list.html#cmdoption-compartment-id

       oci cloud-bridge inventory asset list --compartment-id $compartment_id
