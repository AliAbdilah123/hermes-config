...
=====
   ...
   oci os-management-hub managed-instance list-updatable-packages [OPTIONS]
...
security policies before trying the examples.
       ...
       export managed_instance_id=<substitute-value-of-managed_instance_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/os-management-hub/managed-instance/list-updatable-packages.html#cmdoption-managed-instance-id

       oci os-management-hub managed-instance list-updatable-packages --managed-instance-id $managed_instance_id
