...
=====
   ...
   oci fleet-software-update fsu-readiness-check create [OPTIONS]
...
security policies before trying the examples.
       ...
       oci fleet-software-update fsu-readiness-check create --compartment-id $compartment_id --type $type
