...
=====
   ...
   oci identity-domains identity-proofing-provider-template put [OPTIONS]


Required Parameters
===================

--identity-proofing-provider-template-id [text]
...
- mutability: readWrite  - required: true  - returned: default  -
...
IdentityProofingProviderTemplateConfiguration.  For documentation on
IdentityProofingProviderTemplateConfiguration please see our API
reference: https://docs.oracle.com/en-us/iaas/api/#/en/identitydomain
s/v1/datatypes/IdentityProofingProviderTemplateConfiguration. This is
...
example parameters with your own.
       ...
       oci identity-domains identity-proofing-provider-template create --generate-param-json-input schemas > schemas.json
       oci identity-domains identity-proofing-provider-template create --generate-param-json-input service-type > service-type.json

       oci identity-domains identity-proofing-provider-template put --generate-param-json-input schemas > schemas.json
       oci identity-domains identity-proofing-provider-template put --generate-param-json-input service-type > service-type.json
...
security policies before trying the examples.
       ...
       export provider=<substitute-value-of-provider> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/identity-domains/identity-proofing-provider-template/create.html#cmdoption-provider
       export verification_url=<substitute-value-of-verification_url> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/identity-domains/identity-proofing-provider-template/create.html#cmdoption-verification-url

       identity_proofing_provider_template_id=$(oci identity-domains identity-proofing-provider-template create --provider $provider --schemas file://schemas.json --service-type file://service-type.json --verification-url $verification_url --query data.id --raw-output)

       oci identity-domains identity-proofing-provider-template put --identity-proofing-provider-template-id $identity_proofing_provider_template_id --provider $provider --schemas file://schemas.json --service-type file://service-type.json --verification-url $verification_url
