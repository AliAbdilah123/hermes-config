"update-mcp-toolset-gen-ai-sql-assistant"
*****************************************
...
Updates the specified Database Tools MCP Toolset for a GenAI SQL
assistant.
...
=====
   ...
   oci dbtools mcp-toolset update-mcp-toolset-gen-ai-sql-assistant [OPTIONS]
...
security policies before trying the examples.
       ...
       export mcp_toolset_id=<substitute-value-of-mcp_toolset_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/mcp-toolset/update-mcp-toolset-gen-ai-sql-assistant.html#cmdoption-mcp-toolset-id

       oci dbtools mcp-toolset update-mcp-toolset-gen-ai-sql-assistant --mcp-toolset-id $mcp_toolset_id
