"configure-distributed-autonomous-database-gsm-wallet"
******************************************************
...
Configure wallets on Global Service Manager(GSM) instances for a
...
=====
   ...
   oci distributed-database distributed-autonomous-db-service distributed-autonomous-database configure-distributed-autonomous-database-gsm-wallet [OPTIONS]
...
security policies before trying the examples.
       ...
       export ca_bundle_id=<substitute-value-of-ca_bundle_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/distributed-database/distributed-autonomous-db-service/distributed-autonomous-database/configure-distributed-autonomous-database-gsm-wallet.html#cmdoption-ca-bundle-id
       export certificate_id=<substitute-value-of-certificate_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/distributed-database/distributed-autonomous-db-service/distributed-autonomous-database/configure-distributed-autonomous-database-gsm-wallet.html#cmdoption-certificate-id
       ...
       oci distributed-database distributed-autonomous-db-service distributed-autonomous-database configure-distributed-autonomous-database-gsm-wallet --ca-bundle-id $ca_bundle_id --certificate-id $certificate_id --distributed-autonomous-database-id $distributed_autonomous_database_id
