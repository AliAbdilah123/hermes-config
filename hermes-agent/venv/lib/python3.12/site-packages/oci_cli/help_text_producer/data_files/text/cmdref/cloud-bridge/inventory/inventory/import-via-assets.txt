...
=====
   ...
   oci cloud-bridge inventory inventory import-via-assets [OPTIONS]
...
security policies before trying the examples.
       ...
       export asset_type=<substitute-value-of-asset_type> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/cloud-bridge/inventory/inventory/import-via-assets.html#cmdoption-asset-type
       ...
       oci cloud-bridge inventory inventory import-via-assets --asset-type $asset_type --compartment-id $compartment_id --data $data --inventory-id $inventory_id
