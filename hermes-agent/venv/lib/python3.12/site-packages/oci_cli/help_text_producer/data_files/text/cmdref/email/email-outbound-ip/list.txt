...
=====
   ...
   oci email email-outbound-ip list [OPTIONS]
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/email/email-outbound-ip/list.html#cmdoption-compartment-id

       oci email email-outbound-ip list --compartment-id $compartment_id
