...
=====
   ...
   oci identity-domains identity-proofing-provider-template patch [OPTIONS]
...
example parameters with your own.
       ...
       oci identity-domains identity-proofing-provider-template patch --generate-param-json-input operations > operations.json
       oci identity-domains identity-proofing-provider-template patch --generate-param-json-input schemas > schemas.json
...
security policies before trying the examples.
       ...
       oci identity-domains identity-proofing-provider-template patch --identity-proofing-provider-template-id $identity_proofing_provider_template_id --operations file://operations.json --schemas file://schemas.json
