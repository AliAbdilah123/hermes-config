...
=====
   ...
   oci goldengate deployment add-lock [OPTIONS]
...
security policies before trying the examples.
       ...
       export deployment_id=<substitute-value-of-deployment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/goldengate/deployment/add-lock.html#cmdoption-deployment-id
       export type=<substitute-value-of-type> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/goldengate/deployment/add-lock.html#cmdoption-type

       oci goldengate deployment add-lock --deployment-id $deployment_id --type $type
