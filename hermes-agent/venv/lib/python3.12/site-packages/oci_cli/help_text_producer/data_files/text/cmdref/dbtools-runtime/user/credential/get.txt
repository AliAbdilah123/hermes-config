...
=====
   ...
   oci dbtools-runtime user credential get [OPTIONS]
...
security policies before trying the examples.
       ...
       export connection_id=<substitute-value-of-connection_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools-runtime/user/credential/get.html#cmdoption-connection-id
       export credential_key=<substitute-value-of-credential_key> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools-runtime/user/credential/get.html#cmdoption-credential-key
       export user_key=<substitute-value-of-user_key> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools-runtime/user/credential/get.html#cmdoption-user-key

       oci dbtools-runtime user credential get --connection-id $connection_id --credential-key $credential_key --user-key $user_key
