...
specific MySQL server’s replication group. MySQL support within OCI
Database Management service has been deprecated as of January 29,
2026.
...
=====
   ...
   oci database-management managed-my-sql-databases managed-my-sql-database list-high-availability-members [OPTIONS]
...
default sort by field is ‘memberHost’. The default sort order for
‘memberHost’ is ascending. The ‘memberHost’ sort order is case-
sensitive.
...
security policies before trying the examples.
       ...
       export managed_my_sql_database_id=<substitute-value-of-managed_my_sql_database_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/database-management/managed-my-sql-databases/managed-my-sql-database/list-high-availability-members.html#cmdoption-managed-my-sql-database-id

       oci database-management managed-my-sql-databases managed-my-sql-database list-high-availability-members --managed-my-sql-database-id $managed_my_sql_database_id
