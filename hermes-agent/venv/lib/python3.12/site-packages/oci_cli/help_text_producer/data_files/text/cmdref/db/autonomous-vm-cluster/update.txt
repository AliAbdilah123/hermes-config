...
Updates the specified Autonomous VM cluster for the Exadata
Cloud@Customer system.To update an Autonomous VM Cluster in the Oracle
cloud, see UpdateCloudAutonomousVmCluster.
...
The new value of autonomous data storage (in TBs) for the Autonomous
VM cluster.

--cpu-core-count-per-node [integer]

The new value of cpus per Autonomous VM cluster per node for the
