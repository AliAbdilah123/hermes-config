...
=====
   ...
   oci identity-domains identity-proofing-provider put [OPTIONS]


Required Parameters
===================

--claim-mapping [complex type]

Configure the verification claims and IAM Domain user attribute
mapping.

**SCIM++ Properties:**  - idcsSearchable: false  - multiValued: true
- mutability: immutable  - required: true  - returned: always  -
idcsCompositeKey: [verifiableClaim]  - type: complex  - uniqueness:
server This is a complex type whose value must be valid JSON. The
...
**SCIM++ Properties:**  - idcsSearchable: false  - multiValued: true
- mutability: immutable  - required: true  - returned: always  -
idcsCompositeKey: [name]  - type: complex  - uniqueness: server This
...
--identity-proofing-provider-id [text]
...
- mutability: readWrite  - required: true  - returned: always  - type:
...
- mutability: readWrite  - idcsCanonicalValueSourceFilter: provider eq
“$(provider)”  - idcsCanonicalValueSourceResourceType:
IdentityProofingProviderTemplate  - caseExact: true  - required: true
...
Description field to add comments and additional information about the
...
--idcs-locked-operations [text]

Operations that are locked on the resource.

**SCIM++ Properties:**  - idcsSearchable: false  -
idcsCsvAttributeNameMappings: [[columnHeaderName:Locked Operations,
multiValueDelimiter:;]]  - multiValued: true  - mutability: readWrite
...
--runtime-data [complex type]

Identity Proofing runtime custom data.

**Added In:** 2505161800

**SCIM++ Properties:**  - idcsCompositeKey: [attrName]  - multiValued:
true  - mutability: readWrite  - required: false  - returned: default
- type: complex

This option is a JSON list with items of type
IdentityProofingProviderRuntimeData.  For documentation on
IdentityProofingProviderRuntimeData please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/identitydomains/v1/dataty
pes/IdentityProofingProviderRuntimeData. This is a complex type whose
...
**SCIM++ Properties:**  - idcsSearchable: true  - multiValued: false
- caseExact: true  - mutability: readWrite  - required: false  -
returned: default  - type: string  - uniqueness: none
...
on tags please see our API reference: https://docs.oracle.com/en-
us/iaas/api/#/en/identitydomains/v1/datatypes/Tags. This is a complex
...
example parameters with your own.
       ...
       oci identity-domains identity-proofing-provider create --generate-param-json-input claim-mapping > claim-mapping.json
       oci identity-domains identity-proofing-provider create --generate-param-json-input configuration > configuration.json
       oci identity-domains identity-proofing-provider create --generate-param-json-input schemas > schemas.json

       oci identity-domains identity-proofing-provider put --generate-param-json-input claim-mapping > claim-mapping.json
       oci identity-domains identity-proofing-provider put --generate-param-json-input configuration > configuration.json
       oci identity-domains identity-proofing-provider put --generate-param-json-input schemas > schemas.json
...
security policies before trying the examples.
       ...
       export name=<substitute-value-of-name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/identity-domains/identity-proofing-provider/create.html#cmdoption-name
       export provider=<substitute-value-of-provider> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/identity-domains/identity-proofing-provider/create.html#cmdoption-provider

       identity_proofing_provider_id=$(oci identity-domains identity-proofing-provider create --claim-mapping file://claim-mapping.json --configuration file://configuration.json --name $name --provider $provider --schemas file://schemas.json --query data.id --raw-output)

       oci identity-domains identity-proofing-provider put --claim-mapping file://claim-mapping.json --configuration file://configuration.json --identity-proofing-provider-id $identity_proofing_provider_id --name $name --provider $provider --schemas file://schemas.json
