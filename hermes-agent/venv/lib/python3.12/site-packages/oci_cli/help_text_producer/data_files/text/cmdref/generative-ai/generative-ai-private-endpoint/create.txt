...
The OCID of the customer’s subnet where the private endpoint VNIC will
reside.
...
private endpoint’s VNIC to. This is a complex type whose value must be
...
“enforce”}}}* This is a complex type whose value must be valid JSON.
...
security policies before trying the examples.
       ...
       oci generative-ai generative-ai-private-endpoint create --compartment-id $compartment_id --dns-prefix $dns_prefix --subnet-id $subnet_id
