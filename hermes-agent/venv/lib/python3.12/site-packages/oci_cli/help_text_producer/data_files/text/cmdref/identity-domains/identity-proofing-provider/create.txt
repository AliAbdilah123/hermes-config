...
=====
   ...
   oci identity-domains identity-proofing-provider create [OPTIONS]
...
security policies before trying the examples.
       ...
       oci identity-domains identity-proofing-provider create --claim-mapping file://claim-mapping.json --configuration file://configuration.json --name $name --provider $provider --schemas file://schemas.json
