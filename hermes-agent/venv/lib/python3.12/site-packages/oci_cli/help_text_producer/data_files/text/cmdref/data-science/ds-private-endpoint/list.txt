...
The query must include compartmentId. The query can also include one
other parameter. If the query doesn’t include compartmentId, or
includes compartmentId with two or more other parameters, then an
error is returned.
...
=====
   ...
   oci data-science ds-private-endpoint list [OPTIONS]
