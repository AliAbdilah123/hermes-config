...
=====
   ...
   oci fusion-apps vanity-domain submit-vanity-domain-validation [OPTIONS]
...
security policies before trying the examples.
       ...
       oci fusion-apps vanity-domain submit-vanity-domain-validation --fusion-environment-id $fusion_environment_id --vanity-domain-id $vanity_domain_id
