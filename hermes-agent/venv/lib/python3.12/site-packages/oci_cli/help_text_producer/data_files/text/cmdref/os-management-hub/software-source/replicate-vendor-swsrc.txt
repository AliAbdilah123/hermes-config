...
=====
   ...
   oci os-management-hub software-source replicate-vendor-swsrc [OPTIONS]
...
--origin-display-name [text]

The display name of the software source to be replicated

--origin-software-source-id [text]

The OCID of the vendor software source in the root compartment that is
being replicated.
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/os-management-hub/software-source/replicate-vendor-swsrc.html#cmdoption-compartment-id

       oci os-management-hub software-source replicate-vendor-swsrc --compartment-id $compartment_id
