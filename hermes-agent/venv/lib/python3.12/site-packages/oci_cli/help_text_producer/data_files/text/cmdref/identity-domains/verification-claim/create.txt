...
=====
   ...
   oci identity-domains verification-claim create [OPTIONS]
...
--verifiable-claims [complex type]
...
example parameters with your own.
       ...
       oci identity-domains verification-claim create --generate-param-json-input schemas > schemas.json
...
security policies before trying the examples.
       ...
       export oidc_provider=<substitute-value-of-oidc_provider> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/identity-domains/verification-claim/create.html#cmdoption-oidc-provider

       oci identity-domains verification-claim create --oidc-provider $oidc_provider --schemas file://schemas.json
