...
Get Forecast predictions for CPU and Storage resources since a time in
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/opsi/database-insights/summarize-database-insight-resource-forecast-trend.html#cmdoption-compartment-id
       export resource_metric=<substitute-value-of-resource_metric> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/opsi/database-insights/summarize-database-insight-resource-forecast-trend.html#cmdoption-resource-metric

       oci opsi database-insights summarize-database-insight-resource-forecast-trend --compartment-id $compartment_id --resource-metric $resource_metric
