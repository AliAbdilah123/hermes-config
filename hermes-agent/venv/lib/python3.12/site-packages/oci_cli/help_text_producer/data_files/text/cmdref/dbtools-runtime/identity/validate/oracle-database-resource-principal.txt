"oracle-database-resource-principal"
************************************
...
Validates the Database Tools identity credentials by establishing a
connection to the customer database and executing the
dbms_cloud.send_request to validate the credential.


Usage
=====

   oci dbtools-runtime identity validate oracle-database-resource-principal [OPTIONS]
...
security policies before trying the examples.
       ...
       export identity_id=<substitute-value-of-identity_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools-runtime/identity/validate/oracle-database-resource-principal.html#cmdoption-identity-id

       oci dbtools-runtime identity validate oracle-database-resource-principal --identity-id $identity_id
