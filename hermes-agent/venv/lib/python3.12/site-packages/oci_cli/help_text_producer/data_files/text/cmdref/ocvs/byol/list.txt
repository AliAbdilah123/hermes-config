...
Lists the BYOLs in the specified compartment. The list can be filtered
by display name or availability domain.


Usage
=====

   oci ocvs byol list [OPTIONS]
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/ocvs/byol/list.html#cmdoption-compartment-id

       oci ocvs byol list --compartment-id $compartment_id
