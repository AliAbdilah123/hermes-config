...
Rollback public api endpoint decommission for a cluster, legacy
kubernetes endpoint will be brought back once the operation is
completed. The operation can only be performed within decommission
rollback deadline.
...
=====
   ...
   oci ce cluster rollback-public-api-endpoint-decommission [OPTIONS]
...
security policies before trying the examples.
       ...
       oci ce cluster rollback-public-api-endpoint-decommission --cluster-id $cluster_id
