...
=====
   ...
   oci fusion-apps vanity-domain-activity update [OPTIONS]
...
--vanity-domain-activity-id [text]
...
security policies before trying the examples.
       ...
       export operation_type=<substitute-value-of-operation_type> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fusion-apps/vanity-domain-activity/create.html#cmdoption-operation-type
       export time_scheduled=<substitute-value-of-time_scheduled> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/fusion-apps/vanity-domain-activity/create.html#cmdoption-time-scheduled
       ...
       vanity_domain_activity_id=$(oci fusion-apps vanity-domain-activity create --fusion-environment-id $fusion_environment_id --operation-type $operation_type --time-scheduled $time_scheduled --vanity-domain-id $vanity_domain_id --query data.id --raw-output)

       oci fusion-apps vanity-domain-activity update --fusion-environment-id $fusion_environment_id --vanity-domain-activity-id $vanity_domain_activity_id
