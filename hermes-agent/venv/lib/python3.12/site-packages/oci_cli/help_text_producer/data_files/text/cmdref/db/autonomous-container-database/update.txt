...
Updates the properties of an Autonomous Container Database, such as
display name, maintenance preference, backup retention, and tags.


Usage
=====

   oci db autonomous-container-database update [OPTIONS]
...
number of days before schedlued maintenance of the primary database.
...
security policies before trying the examples.
       ...
       oci db autonomous-container-database update --autonomous-container-database-id $autonomous_container_database_id
