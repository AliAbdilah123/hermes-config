...
Retrieves general information regarding the replication of a specific
...
=====
   ...
   oci database-management managed-my-sql-databases managed-my-sql-database get-general-replication-information [OPTIONS]
...
security policies before trying the examples.
       ...
       export managed_my_sql_database_id=<substitute-value-of-managed_my_sql_database_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/database-management/managed-my-sql-databases/managed-my-sql-database/get-general-replication-information.html#cmdoption-managed-my-sql-database-id

       oci database-management managed-my-sql-databases managed-my-sql-database get-general-replication-information --managed-my-sql-database-id $managed_my_sql_database_id
