...
=====
   ...
   oci network private-ip bulk-delete [OPTIONS]


Required Parameters
===================

--bulk-delete-private-ip-item [complex type]

A secondary IPv4 address to delete. This is a complex type whose value
...
OCID of the VLAN from which the private IP is to be deleted.

--vnic-id [text]

The OCID of the VNIC of which private IPs should be deleted. The VNIC
...
example parameters with your own.
       ...
       oci network private-ip bulk-delete --generate-param-json-input bulk-delete-private-ip-item > bulk-delete-private-ip-item.json
...
security policies before trying the examples.
       ...
       oci network private-ip bulk-delete --bulk-delete-private-ip-item file://bulk-delete-private-ip-item.json
