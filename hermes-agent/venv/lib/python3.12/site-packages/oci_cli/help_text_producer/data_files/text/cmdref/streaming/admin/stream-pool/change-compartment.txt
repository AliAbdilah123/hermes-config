...
=====
   ...
   oci streaming admin stream-pool change-compartment [OPTIONS]
...
security policies before trying the examples.
       ...
       oci streaming admin stream-pool change-compartment --compartment-id $compartment_id --stream-pool-id $stream_pool_id
