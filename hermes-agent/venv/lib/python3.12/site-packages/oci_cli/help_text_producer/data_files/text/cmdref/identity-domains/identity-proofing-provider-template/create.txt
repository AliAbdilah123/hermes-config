...
=====
   ...
   oci identity-domains identity-proofing-provider-template create [OPTIONS]
...
security policies before trying the examples.
       ...
       oci identity-domains identity-proofing-provider-template create --provider $provider --schemas file://schemas.json --service-type file://service-type.json --verification-url $verification_url
