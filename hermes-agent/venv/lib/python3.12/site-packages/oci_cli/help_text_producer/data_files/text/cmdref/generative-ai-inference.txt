...
**Important:** The IP addresses behind each DNS endpoint might change
over time. Always use the DNS hostname listed under the following
**CLI Endpoints** section and avoid using hard-coded fixed IP
addresses.
