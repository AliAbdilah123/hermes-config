"create-autonomous-container-database-create-autonomous-container-database-from-backup-details"
***********************************************************************************************
...
=====
   ...
   oci db autonomous-container-database create-autonomous-container-database-create-autonomous-container-database-from-backup-details [OPTIONS]
...
--encryption-key-location-details [complex type]
...
security policies before trying the examples.
       ...
       export autonomous_container_database_backup_id=<substitute-value-of-autonomous_container_database_backup_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/autonomous-container-database/create-autonomous-container-database-create-autonomous-container-database-from-backup-details.html#cmdoption-autonomous-container-database-backup-id
       export display_name=<substitute-value-of-display_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/autonomous-container-database/create-autonomous-container-database-create-autonomous-container-database-from-backup-details.html#cmdoption-display-name
       export patch_model=<substitute-value-of-patch_model> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/autonomous-container-database/create-autonomous-container-database-create-autonomous-container-database-from-backup-details.html#cmdoption-patch-model

       oci db autonomous-container-database create-autonomous-container-database-create-autonomous-container-database-from-backup-details --autonomous-container-database-backup-id $autonomous_container_database_backup_id --display-name $display_name --patch-model $patch_model
