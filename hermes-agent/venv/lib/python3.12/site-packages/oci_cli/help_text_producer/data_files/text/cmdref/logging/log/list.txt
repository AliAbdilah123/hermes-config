...
When setting the page limit, specifies the maximum number of
unfiltered records that can be fetched from the data store in one
request. Filtering happens after the records are retrieved. Subsequent
...
Log object resource, which is a field of
LogSummary.Configuration.Source.

--source-service [text]

Service that created the log object, which is a field of
LogSummary.Configuration.Source.
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/logging/log-group/create.html#cmdoption-compartment-id
