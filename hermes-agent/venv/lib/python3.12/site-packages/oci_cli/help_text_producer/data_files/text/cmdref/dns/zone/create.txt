...
documentation on ExternalDownstream please see our API reference:
https://docs.oracle.com/en-
us/iaas/api/#/en/dns/20180115/datatypes/ExternalDownstream. This is a
...
https://docs.oracle.com/en-
us/iaas/api/#/en/dns/20180115/datatypes/ExternalMaster. This is a
complex type whose value must be valid JSON. The value can be provided
as a string on the command line or passed in as a file using the
file://path/to/file syntax.
...
--resolution-mode [text]

The resolution mode of a zone defines behavior related to how query
responses can be handled.

Accepted values are:

   RTYPE_TRANSPARENT, STATIC, TRANSPARENT
