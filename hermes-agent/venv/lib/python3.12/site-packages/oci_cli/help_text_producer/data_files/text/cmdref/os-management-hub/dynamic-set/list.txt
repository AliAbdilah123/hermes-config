...
Lists dynamic sets that match the specified compartment or dynamic set
OCID. Filter the list against a variety of criteria including but not
...
=====
   ...
   oci os-management-hub dynamic-set list [OPTIONS]
...
security policies before trying the examples.
       ...
       oci os-management-hub dynamic-set list
