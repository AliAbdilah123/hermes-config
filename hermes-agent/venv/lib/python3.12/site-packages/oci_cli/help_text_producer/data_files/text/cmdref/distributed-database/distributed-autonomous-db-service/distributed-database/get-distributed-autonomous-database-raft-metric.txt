"get-distributed-autonomous-database-raft-metric"
*************************************************
...
Operation to retrieve RAFT metrics for the Globally distributed
autonomous database. If the Globally distributed autonomous database
is not RAFT based then empty response is returned from the API.


Usage
=====

   oci distributed-database distributed-autonomous-db-service distributed-database get-distributed-autonomous-database-raft-metric [OPTIONS]
...
security policies before trying the examples.
       ...
       oci distributed-database distributed-autonomous-db-service distributed-database get-distributed-autonomous-database-raft-metric --distributed-autonomous-database-id $distributed_autonomous_database_id
