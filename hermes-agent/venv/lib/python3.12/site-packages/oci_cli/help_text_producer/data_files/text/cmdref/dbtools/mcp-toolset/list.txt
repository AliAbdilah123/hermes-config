...
=====
   ...
   oci dbtools mcp-toolset list [OPTIONS]
...
*databaseToolsMcpToolsetLifecycleState* matches the specified
...
A filter to return only resources matching the specified
...
Accepted values are:
   ...
   BUILT_IN_SQL_TOOLS, CUSTOMIZABLE_REPORTING_TOOLS, CUSTOM_SQL_TOOL, GENAI_SQL_ASSISTANT
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/dbtools/mcp-toolset/list.html#cmdoption-compartment-id

       oci dbtools mcp-toolset list --compartment-id $compartment_id
