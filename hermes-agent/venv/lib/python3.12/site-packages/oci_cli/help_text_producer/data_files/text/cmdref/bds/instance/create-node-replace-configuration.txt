...
example parameters with your own.
       ...
       oci bds instance create-node-replace-configuration --generate-param-json-input level-type-details > level-type-details.json
...
security policies before trying the examples.
       ...
       export bds_instance_id=<substitute-value-of-bds_instance_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/bds/instance/create-node-replace-configuration.html#cmdoption-bds-instance-id
       export duration_in_minutes=<substitute-value-of-duration_in_minutes> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/bds/instance/create-node-replace-configuration.html#cmdoption-duration-in-minutes
       export metric_type=<substitute-value-of-metric_type> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/bds/instance/create-node-replace-configuration.html#cmdoption-metric-type

       oci bds instance create-node-replace-configuration --bds-instance-id $bds_instance_id --duration-in-minutes $duration_in_minutes --level-type-details file://level-type-details.json --metric-type $metric_type
