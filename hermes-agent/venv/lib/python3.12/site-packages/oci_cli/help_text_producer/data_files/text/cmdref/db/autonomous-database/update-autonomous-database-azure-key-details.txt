"update-autonomous-database-azure-key-details"
**********************************************
...
=====
   ...
   oci db autonomous-database update-autonomous-database-azure-key-details [OPTIONS]
...
security policies before trying the examples.
       ...
       export encryption_key_key_name=<substitute-value-of-encryption_key_key_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/autonomous-database/update-autonomous-database-azure-key-details.html#cmdoption-encryption-key-key-name
       export encryption_key_vault_uri=<substitute-value-of-encryption_key_vault_uri> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/autonomous-database/update-autonomous-database-azure-key-details.html#cmdoption-encryption-key-vault-uri
       ...
       oci db autonomous-database update-autonomous-database-azure-key-details --autonomous-database-id $autonomous_database_id --encryption-key-key-name $encryption_key_key_name --encryption-key-vault-uri $encryption_key_vault_uri
