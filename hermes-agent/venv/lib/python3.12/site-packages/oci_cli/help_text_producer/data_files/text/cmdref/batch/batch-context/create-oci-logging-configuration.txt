...
--is-job-task-events-propagation-enabled [boolean]

A switch to enable or disable propagation of job and task events to
the customer’s logs in OCI logging service.
...
JobPriorityConfiguration please see our API reference:
https://docs.oracle.com/en-us/iaas/api/#/en/batchcomputing/20251031/d
atatypes/JobPriorityConfiguration. This is a complex type whose value
...
example parameters with your own.
       ...
       oci batch batch-context create-oci-logging-configuration --generate-param-json-input fleets > fleets.json
       oci batch batch-context create-oci-logging-configuration --generate-param-json-input network > network.json
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/batch/batch-context/create-oci-logging-configuration.html#cmdoption-compartment-id
       export log_group_id=<substitute-value-of-log_group_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/batch/batch-context/create-oci-logging-configuration.html#cmdoption-log-group-id
       export log_id=<substitute-value-of-log_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/batch/batch-context/create-oci-logging-configuration.html#cmdoption-log-id

       oci batch batch-context create-oci-logging-configuration --compartment-id $compartment_id --fleets file://fleets.json --log-group-id $log_group_id --log-id $log_id --network file://network.json
