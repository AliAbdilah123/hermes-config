...
=====
   ...
   oci generative-ai-inference rerank-text-result rerank-text [OPTIONS]
...
example parameters with your own.
       ...
       oci generative-ai-inference rerank-text-result rerank-text --generate-param-json-input documents > documents.json
       oci generative-ai-inference rerank-text-result rerank-text --generate-param-json-input serving-mode > serving-mode.json
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/generative-ai-inference/rerank-text-result/rerank-text.html#cmdoption-compartment-id
       export input=<substitute-value-of-input> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/generative-ai-inference/rerank-text-result/rerank-text.html#cmdoption-input

       oci generative-ai-inference rerank-text-result rerank-text --compartment-id $compartment_id --documents file://documents.json --input $input --serving-mode file://serving-mode.json
