...
security policies before trying the examples.
       ...
       oci bds instance create-node-replace-configuration-node-level-details --bds-instance-id $bds_instance_id --duration-in-minutes $duration_in_minutes --level-type-details-node-host-name $level_type_details_node_host_name --metric-type $metric_type
