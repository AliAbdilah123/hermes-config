...
=====
   ...
   oci rover device data-sync task start [OPTIONS]
...
The OCID of the Task Definition that is to be executed.
...
--multipart-threads [integer]

Number of threads to process multiparts per file. Default to 1.

--threads [integer]

Number of threads to copy files concurrently. Default to 1.
...
security policies before trying the examples.
       ...
       oci rover device data-sync task start --task-definition-id $task_definition_id
