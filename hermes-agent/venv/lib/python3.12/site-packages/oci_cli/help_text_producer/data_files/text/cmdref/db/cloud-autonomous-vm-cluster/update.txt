...
Updates the specified Autonomous Exadata VM cluster in the Oracle
cloud. For Exadata Cloud@Customer systems, see
...
=====
   ...
   oci db cloud-autonomous-vm-cluster update [OPTIONS]
