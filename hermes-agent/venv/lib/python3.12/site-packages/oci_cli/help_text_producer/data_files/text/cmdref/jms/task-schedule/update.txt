...
=====
   ...
   oci jms task-schedule update [OPTIONS]
...
example parameters with your own.
       ...
       oci jms task-schedule update --generate-param-json-input task-details > task-details.json
...
security policies before trying the examples.
       ...
       oci jms task-schedule update --execution-recurrences $execution_recurrences --fleet-id $fleet_id --task-details file://task-details.json --task-schedule-id $task_schedule_id
