...
=====
   ...
   oci fusion-apps email-subdomain update [OPTIONS]
...
security policies before trying the examples.
       ...
       oci fusion-apps email-subdomain update --email-subdomain-id $email_subdomain_id --fusion-environment-id $fusion_environment_id --marketing-brand-id $marketing_brand_id
