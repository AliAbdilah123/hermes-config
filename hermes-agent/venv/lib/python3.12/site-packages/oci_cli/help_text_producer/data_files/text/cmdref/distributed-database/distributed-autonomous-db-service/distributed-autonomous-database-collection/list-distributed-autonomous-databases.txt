"list-distributed-autonomous-databases"
***************************************
...
=====
   ...
   oci distributed-database distributed-autonomous-db-service distributed-autonomous-database-collection list-distributed-autonomous-databases [OPTIONS]
...
A filter to return only resources their dbDeploymentType matches the
given dbDeploymentType.
...
A filter to return only Globally distributed autonomous databases that
match the entire name given. The match is not case sensitive.
...
Comma separated names of argument corresponding to which metadata need
to be retrived.
...
A filter to return only resources that are associated with the given
privateEndpointId.
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/distributed-database/distributed-autonomous-db-service/distributed-autonomous-database-collection/list-distributed-autonomous-databases.html#cmdoption-compartment-id

       oci distributed-database distributed-autonomous-db-service distributed-autonomous-database-collection list-distributed-autonomous-databases --compartment-id $compartment_id
