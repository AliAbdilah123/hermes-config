...
function GetOciCommandsToLongParams_jms() {
    $ociCommandsToLongParams = @{
        ...
        'jms installation-usage summarize' = 'application-id fields fleet-id from-json help installation-path jre-distribution jre-security-status jre-vendor jre-version limit managed-instance-id os-family page path-contains sort-by sort-order time-end time-start'
