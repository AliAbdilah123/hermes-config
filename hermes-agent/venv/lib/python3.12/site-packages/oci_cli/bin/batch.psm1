...
function GetOciSubcommands_batch() {
    $ociSubcommands = @{
        ...
        'batch batch-context' = 'change-compartment create create-oci-logging-configuration delete get list start stop update update-oci-logging-configuration'
        ...
        'batch batch-task-profile' = 'change-compartment create create-cpu-architecture create-cpu-shape create-gpu-shape delete get list update'
...
function GetOciCommandsToLongParams_batch() {
    $ociCommandsToLongParams = @{
        ...
        'batch batch-context create-oci-logging-configuration' = 'compartment-id defined-tags description display-name entitlements fleets freeform-tags from-json help is-job-task-events-propagation-enabled job-priority-configurations log-group-id log-id max-wait-seconds network wait-for-state wait-interval-seconds'
        ...
        'batch batch-context update' = 'batch-context-id defined-tags description display-name entitlements force freeform-tags from-json help if-match job-priority-configurations logging-configuration max-wait-seconds wait-for-state wait-interval-seconds'
        'batch batch-context update-oci-logging-configuration' = 'batch-context-id defined-tags description display-name entitlements force freeform-tags from-json help if-match job-priority-configurations logging-configuration-is-job-task-events-propagation-enabled max-wait-seconds wait-for-state wait-interval-seconds'
        'batch batch-context-shape-collection list' = 'all availability-domain compartment-id from-json help limit page page-size shape-type'
        ...
        'batch batch-task list' = 'all batch-job-id from-json group-task-name help hierarchy-view lifecycle-state limit name page page-size sort-by sort-order task-id type'
        'batch batch-task list-batch-tasks' = 'all batch-job-id compartment-id from-json help lifecycle-state limit name page page-size sort-by sort-order task-id'
        ...
        'batch batch-task-profile create' = 'compartment-id defined-tags description display-name extended-information freeform-tags from-json help max-wait-seconds min-disk-size-in-gbs min-memory-in-gbs min-ocpus wait-for-state wait-interval-seconds'
        'batch batch-task-profile create-cpu-architecture' = 'compartment-id defined-tags description display-name extended-information-architecture freeform-tags from-json help max-wait-seconds min-disk-size-in-gbs min-memory-in-gbs min-ocpus wait-for-state wait-interval-seconds'
        'batch batch-task-profile create-cpu-shape' = 'compartment-id defined-tags description display-name extended-information-shape-name freeform-tags from-json help max-wait-seconds min-disk-size-in-gbs min-memory-in-gbs min-ocpus wait-for-state wait-interval-seconds'
        'batch batch-task-profile create-gpu-shape' = 'compartment-id defined-tags description display-name extended-information-shape-name freeform-tags from-json help max-wait-seconds min-disk-size-in-gbs min-memory-in-gbs min-ocpus wait-for-state wait-interval-seconds'
...
function GetOciCommandsToShortParams_batch() {
    $ociCommandsToShortParams = @{
        ...
        'batch batch-context update-oci-logging-configuration' = '? h'
        ...
        'batch batch-task-profile create-cpu-architecture' = '? c h'
        'batch batch-task-profile create-cpu-shape' = '? c h'
        'batch batch-task-profile create-gpu-shape' = '? c h'
