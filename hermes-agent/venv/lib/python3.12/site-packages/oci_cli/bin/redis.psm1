...
function GetOciSubcommands_redis() {
    $ociSubcommands = @{
        'redis' = 'oci-cache-backup oci-cache-config-set oci-cache-default-config-set oci-cache-engine-options oci-cache-user redis-cluster redis-identity'
        'redis oci-cache-backup' = 'oci-cache-backup oci-cache-backup-summary'
        'redis oci-cache-backup oci-cache-backup' = 'change-compartment create delete export-oci-cache-backup-to-object-storage get update'
        'redis oci-cache-backup oci-cache-backup-summary' = 'list-oci-cache-backups'
        ...
        'redis oci-cache-engine-options' = 'oci-cache-engine-option-summary'
        'redis oci-cache-engine-options oci-cache-engine-option-summary' = 'list-oci-cache-engine-options'
...
function GetOciCommandsToLongParams_redis() {
    $ociCommandsToLongParams = @{
        'redis oci-cache-backup oci-cache-backup change-compartment' = 'compartment-id from-json help if-match max-wait-seconds oci-cache-backup-id wait-for-state wait-interval-seconds'
        'redis oci-cache-backup oci-cache-backup create' = 'backup-source compartment-id defined-tags description display-name freeform-tags from-json help max-wait-seconds retention-period-in-days source-cluster-id wait-for-state wait-interval-seconds'
        'redis oci-cache-backup oci-cache-backup delete' = 'force from-json help if-match max-wait-seconds oci-cache-backup-id wait-for-state wait-interval-seconds'
        'redis oci-cache-backup oci-cache-backup export-oci-cache-backup-to-object-storage' = 'bucket-name from-json help if-match max-wait-seconds namespace-name oci-cache-backup-id prefix wait-for-state wait-interval-seconds'
        'redis oci-cache-backup oci-cache-backup get' = 'from-json help oci-cache-backup-id'
        'redis oci-cache-backup oci-cache-backup update' = 'defined-tags description display-name force freeform-tags from-json help if-match max-wait-seconds oci-cache-backup-id retention-period-in-days wait-for-state wait-interval-seconds'
        'redis oci-cache-backup oci-cache-backup-summary list-oci-cache-backups' = 'all compartment-id display-name from-json help lifecycle-state limit oci-cache-backup-id page page-size sort-by sort-order source-cluster-id'
        ...
        'redis oci-cache-engine-options oci-cache-engine-option-summary list-oci-cache-engine-options' = 'all compartment-id from-json help limit page page-size sort-by sort-order'
        ...
        'redis redis-cluster redis-cluster create' = 'backup-id cluster-mode compartment-id defined-tags display-name freeform-tags from-json help import-from-object-storage-details max-wait-seconds node-count node-memory-in-gbs nsg-ids oci-cache-config-set-id security-attributes shard-count software-version subnet-id wait-for-state wait-interval-seconds'
        ...
        'redis redis-identity create-identity-token-details create-identity-token' = 'from-json help if-match public-key redis-cluster-id redis-user'
    }
...
function GetOciCommandsToShortParams_redis() {
    $ociCommandsToShortParams = @{
        'redis oci-cache-backup oci-cache-backup change-compartment' = '? c h'
        'redis oci-cache-backup oci-cache-backup create' = '? c h'
        'redis oci-cache-backup oci-cache-backup delete' = '? h'
        'redis oci-cache-backup oci-cache-backup export-oci-cache-backup-to-object-storage' = '? h'
        'redis oci-cache-backup oci-cache-backup get' = '? h'
        'redis oci-cache-backup oci-cache-backup update' = '? h'
        'redis oci-cache-backup oci-cache-backup-summary list-oci-cache-backups' = '? c h'
        ...
        'redis oci-cache-engine-options oci-cache-engine-option-summary list-oci-cache-engine-options' = '? c h'
