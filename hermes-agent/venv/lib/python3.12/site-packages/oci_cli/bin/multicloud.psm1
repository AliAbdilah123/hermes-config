...
function GetOciSubcommands_multicloud() {
    $ociSubcommands = @{
        'multicloud' = 'metadata multi-clouds-metadata multicloud-alerts multicloud-policies multicloud-resources multicloudsubscriptions omhub-network-anchor omhub-resource-anchor'
        ...
        'multicloud multicloud-alerts' = 'multicloud-alert-collection'
        'multicloud multicloud-alerts multicloud-alert-collection' = 'list-multicloud-alerts'
        'multicloud multicloud-policies' = 'multicloud-policy-collection'
        'multicloud multicloud-policies multicloud-policy-collection' = 'list-multicloud-policies'
...
function GetOciCommandsToLongParams_multicloud() {
    $ociCommandsToLongParams = @{
        ...
        'multicloud multicloud-alerts multicloud-alert-collection list-multicloud-alerts' = 'alert-function-name alert-status alert-type all compartment-id display-name from-json help limit page page-size resource-id resource-type severity sort-by sort-order subscription-id subscription-service-name'
        'multicloud multicloud-policies multicloud-policy-collection list-multicloud-policies' = 'all compartment-id display-name from-json help is-force-refresh limit page page-size sort-by sort-order subscription-id'
        'multicloud multicloud-resources multicloud-resource-collection list-multicloud-resources' = 'all compartment-id external-location from-json help limit page page-size resource-anchor-id resource-type sort-by sort-order subscription-id subscription-service-name'
        ...
        'multicloud omhub-network-anchor network-anchor-collection list-network-anchors' = 'all compartment-id display-name external-location from-json help id limit network-anchor-lifecycle-state network-anchor-oci-subnet-id network-anchor-oci-vcn-id page page-size should-fetch-vcn-name sort-by sort-order subscription-id subscription-service-name'
...
function GetOciCommandsToShortParams_multicloud() {
    $ociCommandsToShortParams = @{
        ...
        'multicloud multicloud-alerts multicloud-alert-collection list-multicloud-alerts' = '? c h'
        'multicloud multicloud-policies multicloud-policy-collection list-multicloud-policies' = '? c h'
