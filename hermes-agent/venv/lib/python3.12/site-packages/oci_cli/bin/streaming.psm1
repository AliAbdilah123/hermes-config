...
function GetOciSubcommands_streaming() {
    $ociSubcommands = @{
        ...
        'streaming admin' = 'connect-harness stream stream-pool work-request work-request-error-collection work-request-log-entry work-request-summary-collection'
        ...
        'streaming admin work-request' = 'get'
        'streaming admin work-request-error-collection' = 'list-work-request-errors'
        'streaming admin work-request-log-entry' = 'list-work-request-logs'
        'streaming admin work-request-summary-collection' = 'list-work-requests'
...
function GetOciCommandsToLongParams_streaming() {
    $ociCommandsToLongParams = @{
        'streaming admin connect-harness change-compartment' = 'compartment-id connect-harness-id from-json help if-match max-wait-seconds wait-for-state wait-interval-seconds'
        ...
        'streaming admin stream change-compartment' = 'compartment-id from-json help if-match max-wait-seconds stream-id wait-for-state wait-interval-seconds'
        ...
        'streaming admin stream-pool change-compartment' = 'compartment-id from-json help if-match max-wait-seconds stream-pool-id wait-for-state wait-interval-seconds'
        ...
        'streaming admin work-request get' = 'from-json help work-request-id'
        'streaming admin work-request-error-collection list-work-request-errors' = 'all from-json help limit page page-size sort-by sort-order work-request-id'
        'streaming admin work-request-log-entry list-work-request-logs' = 'all from-json help limit page page-size sort-by sort-order work-request-id'
        'streaming admin work-request-summary-collection list-work-requests' = 'all compartment-id from-json help limit page page-size resource-id sort-by sort-order work-request-id'
...
function GetOciCommandsToShortParams_streaming() {
    $ociCommandsToShortParams = @{
        ...
        'streaming admin work-request get' = '? h'
        'streaming admin work-request-error-collection list-work-request-errors' = '? h'
        'streaming admin work-request-log-entry list-work-request-logs' = '? h'
        'streaming admin work-request-summary-collection list-work-requests' = '? c h'
