...
function GetOciSubcommands_email() {
    $ociSubcommands = @{
        'email' = 'configuration dkim domain email-ip-pool email-outbound-ip email-return-path sender suppression work-request work-request-error work-request-log'
        'email configuration' = 'get-email'
        'email dkim' = 'create delete get list update'
        'email domain' = 'add change-compartment create delete get list remove update'
        'email email-ip-pool' = 'add change-compartment create delete get list remove update'
        'email email-outbound-ip' = 'list'
...
function GetOciCommandsToLongParams_email() {
    $ociCommandsToLongParams = @{
        ...
        'email email-ip-pool create' = 'compartment-id defined-tags description freeform-tags from-json help last-ip-drain-period max-wait-seconds name outbound-ips wait-for-state wait-interval-seconds'
        ...
        'email email-ip-pool list' = 'all compartment-id from-json help id lifecycle-state limit name page page-size sort-by sort-order'
        ...
        'email email-ip-pool update' = 'defined-tags description email-ip-pool-id force freeform-tags from-json help if-match is-lock-override last-ip-drain-period max-wait-seconds wait-for-state wait-interval-seconds'
        'email email-outbound-ip list' = 'all assignment-state compartment-id from-json help lifecycle-state limit outbound-ip page page-size sort-by sort-order'
        ...
        'email work-request list' = 'all compartment-id from-json help limit operation-type page page-size sort-by sort-order status work-request-id'
        'email work-request-error list' = 'all from-json help limit page page-size sort-by sort-order work-request-id'
        'email work-request-log list' = 'all from-json help limit page page-size sort-by sort-order work-request-id'
    }
...
function GetOciCommandsToShortParams_email() {
    $ociCommandsToShortParams = @{
        ...
        'email email-ip-pool list' = '? c h'
        'email email-ip-pool remove' = '? h'
        'email email-ip-pool update' = '? h'
        'email email-outbound-ip list' = '? c h'
