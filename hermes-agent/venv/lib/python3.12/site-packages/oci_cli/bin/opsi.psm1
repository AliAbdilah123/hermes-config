...
function GetOciSubcommands_opsi() {
    $ociSubcommands = @{
        ...
        'opsi chargeback-plan' = 'change-compartment create-chargeback-plan-exadata create-chargeback-plan-report delete delete-chargeback-plan-report get get-chargeback-plan-report get-chargeback-plan-report-content list list-chargeback-plan-reports update update-chargeback-plan-report'
...
function GetOciCommandsToLongParams_opsi() {
    $ociCommandsToLongParams = @{
        ...
        'opsi chargeback-plan change-compartment' = 'chargebackplan-id compartment-id from-json help if-match max-wait-seconds wait-for-state wait-interval-seconds'
        'opsi chargeback-plan create-chargeback-plan-exadata' = 'compartment-id defined-tags freeform-tags from-json help max-wait-seconds plan-custom-items plan-description plan-name plan-type wait-for-state wait-interval-seconds'
        'opsi chargeback-plan create-chargeback-plan-report' = 'from-json help id if-match max-wait-seconds report-name report-properties resource-type wait-for-state wait-interval-seconds'
        'opsi chargeback-plan delete' = 'chargebackplan-id force from-json help if-match max-wait-seconds wait-for-state wait-interval-seconds'
        'opsi chargeback-plan delete-chargeback-plan-report' = 'chargeback-plan-report-id force from-json help id if-match max-wait-seconds resource-type wait-for-state wait-interval-seconds'
        'opsi chargeback-plan get' = 'chargebackplan-id from-json help'
        'opsi chargeback-plan get-chargeback-plan-report' = 'chargeback-plan-report-id from-json help id resource-type'
        'opsi chargeback-plan get-chargeback-plan-report-content' = 'chargeback-plan-report-id file from-json help id relative-time-interval resource-type time-interval-end time-interval-start'
        'opsi chargeback-plan list' = 'all chargebackplan-id compartment-id compartment-id-in-subtree from-json help limit page page-size sort-by sort-order'
        'opsi chargeback-plan list-chargeback-plan-reports' = 'all from-json help id limit page page-size resource-type sort-by sort-order'
        'opsi chargeback-plan update' = 'chargebackplan-id defined-tags force freeform-tags from-json help if-match max-wait-seconds plan-custom-items plan-description plan-name wait-for-state wait-interval-seconds'
        'opsi chargeback-plan update-chargeback-plan-report' = 'chargeback-plan-report-id force from-json help id if-match max-wait-seconds report-name report-properties resource-type wait-for-state wait-interval-seconds'
        ...
        'opsi exadata-insights disable-plan' = 'exadata-insight-id from-json help if-match max-wait-seconds wait-for-state wait-interval-seconds'
        ...
        'opsi exadata-insights enable-plan' = 'exadata-insight-id from-json help if-match max-wait-seconds plan-id wait-for-state wait-interval-seconds'
        ...
        'opsi opsi-private-endpoint create' = 'compartment-id defined-tags description display-name freeform-tags from-json help is-used-for-rac-dbs max-wait-seconds nsg-ids security-attributes subnet-id vcn-id wait-for-state wait-interval-seconds'
        ...
        'opsi opsi-private-endpoint update' = 'defined-tags description display-name force freeform-tags from-json help if-match max-wait-seconds nsg-ids opsi-private-endpoint-id security-attributes wait-for-state wait-interval-seconds'
...
function GetOciCommandsToShortParams_opsi() {
    $ociCommandsToShortParams = @{
        ...
        'opsi chargeback-plan change-compartment' = '? c h'
        'opsi chargeback-plan create-chargeback-plan-exadata' = '? c h'
        'opsi chargeback-plan create-chargeback-plan-report' = '? h'
        'opsi chargeback-plan delete' = '? h'
        'opsi chargeback-plan delete-chargeback-plan-report' = '? h'
        'opsi chargeback-plan get' = '? h'
        'opsi chargeback-plan get-chargeback-plan-report' = '? h'
        'opsi chargeback-plan get-chargeback-plan-report-content' = '? h'
        'opsi chargeback-plan list' = '? c h'
        'opsi chargeback-plan list-chargeback-plan-reports' = '? h'
        'opsi chargeback-plan update' = '? h'
        'opsi chargeback-plan update-chargeback-plan-report' = '? h'
        ...
        'opsi exadata-insights disable-plan' = '? h'
        ...
        'opsi exadata-insights enable-plan' = '? h'
