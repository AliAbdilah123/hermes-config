...
function GetOciCommandsToLongParams_iot() {
    $ociCommandsToLongParams = @{
        ...
        'iot digital-twin-instance create' = 'auth-id connectivity-type defined-tags description digital-twin-adapter-id digital-twin-model-id digital-twin-model-spec-uri display-name external-key freeform-tags from-json gateways help iot-domain-id max-wait-seconds wait-for-state wait-interval-seconds'
        ...
        'iot digital-twin-instance list' = 'all connectivity-type digital-twin-model-id digital-twin-model-spec-uri display-name from-json help id iot-domain-id lifecycle-state limit page page-size sort-by sort-order'
        'iot digital-twin-instance update' = 'auth-id defined-tags description digital-twin-adapter-id digital-twin-instance-id digital-twin-model-id digital-twin-model-spec-uri display-name external-key force freeform-tags from-json gateways help if-match max-wait-seconds wait-for-state wait-interval-seconds'
        ...
        'iot domain-group create' = 'compartment-id defined-tags description display-name freeform-tags from-json help max-wait-seconds type wait-for-state wait-interval-seconds'
        ...
        'iot domain-group list' = 'all compartment-id display-name from-json help id lifecycle-state limit page page-size sort-by sort-order type'
