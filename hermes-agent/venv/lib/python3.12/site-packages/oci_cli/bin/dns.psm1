...
function GetOciCommandsToLongParams_dns() {
    $ociCommandsToLongParams = @{
        ...
        'dns zone create' = 'compartment-id defined-tags dnssec-state external-downstreams external-masters freeform-tags from-json help max-wait-seconds name resolution-mode scope view-id wait-for-state wait-interval-seconds zone-type'
        ...
        'dns zone update' = 'compartment-id defined-tags dnssec-state external-downstreams external-masters force freeform-tags from-json help if-match if-unmodified-since max-wait-seconds resolution-mode scope view-id wait-for-state wait-interval-seconds zone-name-or-id'
