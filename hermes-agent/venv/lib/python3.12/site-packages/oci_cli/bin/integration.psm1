...
function GetOciCommandsToLongParams_integration() {
    $ociCommandsToLongParams = @{
        ...
        'integration integration-instance convert-instance' = 'conversion-phase conversion-type from-json help if-match integration-instance-id max-wait-seconds wait-for-state wait-interval-seconds'
