...
When the task is explicitly reviewable through a public preview, do not report “fixed” after only commit/push, focused tests, or a build. Continue through preview publication and exact public browser verification; the first completion report should include the public URL. If interrupted before then, use the precise state label “implemented; public E2E verification pending,” not “fixed.”
