# Legacy skill package: `service-exposure-debugging`

This file preserves the former `service-exposure-debugging` SKILL.md after consolidation into `web-app-delivery`. Relative support-file links have been rewritten to the re-homed files under `web-app-delivery`.
...
## References
- `references/service-exposure-debugging-iptables-tailscale-port-block.md` — reproduction recipe and filter diff for the DROP+tailscale ACCEPT pattern.
