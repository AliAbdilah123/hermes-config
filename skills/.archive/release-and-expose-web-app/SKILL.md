...
- `nginx-root-return-fix.md`: standard patch pattern for returning a plain text body from `/` on this host, write permissions, reload checklist, and root-return pitfalls.
